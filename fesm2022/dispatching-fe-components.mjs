...
class CustomButtonComponent {
    ...
    static ɵcmp = i0.ɵɵngDeclareComponent({ minVersion: "14.0.0", version: "19.2.14", type: CustomButtonComponent, isStandalone: true, selector: "custom-button", inputs: { disabled: "disabled", type: "type", customClass: "customClass" }, outputs: { buttonClick: "buttonClick" }, ngImport: i0, template: "<button\n  (click)=\"buttonClick.emit()\"\n  type=\"{{ type }}\"\n  [class]=\"'custom-button ' + customClass\"\n  [disabled]=\"disabled\"\n>\n  <ng-content></ng-content>\n</button>\n", styles: [".custom-button{border:none;border-radius:.625em;cursor:pointer;text-align:center;display:flex;justify-content:center;align-items:center;font-size:1em;padding:.6em 1.2em;min-height:2.8em}.custom-button:hover{opacity:.8}.custom-button:disabled{cursor:not-allowed;opacity:1;color:#ddddddd0}.custom-button:disabled *{opacity:.5}\n"] });
}
