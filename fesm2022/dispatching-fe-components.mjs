...
import { retry, catchError, BehaviorSubject, Observable, map, throwError, finalize, tap, Subscription, fromEvent, filter, Subject, debounceTime, distinctUntilChanged, takeUntil } from 'rxjs';
...
class CustomAppErrorComponent {
    ...
    static ɵcmp = i0.ɵɵngDeclareComponent({ minVersion: "17.0.0", version: "19.2.14", type: CustomAppErrorComponent, isStandalone: true, selector: "custom-app-error", inputs: { control: { classPropertyName: "control", publicName: "control", isSignal: false, isRequired: true, transformFunction: null }, validation: { classPropertyName: "validation", publicName: "validation", isSignal: false, isRequired: true, transformFunction: null }, name: { classPropertyName: "name", publicName: "name", isSignal: false, isRequired: true, transformFunction: null }, showErrors: { classPropertyName: "showErrors", publicName: "showErrors", isSignal: true, isRequired: false, transformFunction: null } }, ngImport: i0, template: "@if(hasAnyErrorToShow()){\r\n<div class=\"error-container\">\r\n  @if(this.control.invalid && (this.control.touched || this.control.dirty) &&\r\n  this.getErrorMessage.length>0){\r\n  <div class=\"input-error-message\">\r\n    <span class=\"input-error-pointer\"></span>\r\n    @for (item of validation; track $index) { @if (shouldShowError(item)) {\r\n\r\n    <span class=\"error-message\">\r\n      {{ getErrorMessage(item) | translate }}\r\n    </span>\r\n    }}\r\n  </div>\r\n  }\r\n</div>\r\n}\r\n", styles: [".error-message{color:#fff!important;font-size:.81em;font-weight:500;display:block;position:relative}.input-error-message{position:relative;background:#e55658;color:#fff;font-size:1.1em;padding:.25em .4375em;border-radius:.3em;width:fit-content;z-index:1;top:-.5em;right:1em;display:flex;justify-content:center;align-items:center}.input-error-pointer{position:absolute;left:calc(100% - 1.38em);top:-.45em;width:0;height:0;border-left:.3em solid transparent;border-right:.3em solid transparent;border-bottom:.5em solid #e55658;content:\"\";display:block}.error-container{width:100%;display:flex;justify-content:end;align-items:flex-end}\n"], dependencies: [{ kind: "ngmodule", type: TranslateModule }, { kind: "pipe", type: i1$1.TranslatePipe, name: "translate" }] });
}
...
class CustomCalenderFormComponent {
    ...
    static ɵcmp = i0.ɵɵngDeclareComponent({ minVersion: "17.0.0", version: "19.2.14", type: CustomCalenderFormComponent, isStandalone: true, selector: "custom-calender-form", inputs: { label: "label", placeholder: "placeholder", labelClass: "labelClass", calendarPopUpClass: "calendarPopUpClass", calendarInputClass: "calendarInputClass", calendarContainerClass: "calendarContainerClass", componentClass: "componentClass", minDate: "minDate", maxDate: "maxDate", controlName: "controlName", parentForm: "parentForm", validation: "validation", name: "name", disabled: "disabled", height: "height" }, outputs: { valueChange: "valueChange" }, ngImport: i0, template: "<div [class]=\"'fullWidth ' + componentClass\" [formGroup]=\"parentForm\">\r\n  @if(label){\r\n  <label [for]=\"label\" [class]=\"'custom-label ' + labelClass\">\r\n    {{ label }}\r\n    @if(containRequiredError()){\r\n    <span style=\"color: #f43f5e; font-size: 15px; font-weight: 500\">*</span>\r\n    } @else{\r\n    <span style=\"color: #f43f5e; font-size: 15px; font-weight: 500\"\r\n      >&nbsp;</span\r\n    >\r\n    }\r\n  </label>\r\n  }\r\n\r\n  <div [class]=\"'custom-calendar-container ' + calendarContainerClass\">\r\n    <div class=\"calendar-error-container\">\r\n      <custom-app-error\r\n        [control]=\"parentForm.controls[controlName]\"\r\n        [validation]=\"validation\"\r\n        [name]=\"name\"\r\n      />\r\n    </div>\r\n\r\n    <div\r\n      [class]=\"'custom-calendar-input ' + calendarInputClass\"\r\n      [class.disabled]=\"disabled\"\r\n      [attr.aria-disabled]=\"disabled\"\r\n      (click)=\"!disabled && toggleCalendar()\"\r\n      [class.has-error]=\"\r\n        parentForm.controls[controlName].invalid &&\r\n        parentForm.controls[controlName].touched\r\n      \"\r\n      [ngStyle]=\"{ '--height': height }\"\r\n    >\r\n      <span class=\"placeholder\" *ngIf=\"!value\">{{ placeholder }}</span>\r\n      <span *ngIf=\"value\">{{ formatDisplayDate() }}</span>\r\n      <span class=\"calendar-icon\">\r\n        <svg\r\n          width=\"inherit\"\r\n          height=\"inherit\"\r\n          viewBox=\"0 0 24 24\"\r\n          fill=\"none\"\r\n          xmlns=\"http://www.w3.org/2000/svg\"\r\n        >\r\n          <path\r\n            d=\"M8 2V5\"\r\n            stroke=\"#999999\"\r\n            stroke-width=\"1.5\"\r\n            stroke-miterlimit=\"10\"\r\n            stroke-linecap=\"round\"\r\n            stroke-linejoin=\"round\"\r\n          />\r\n          <path\r\n            d=\"M16 2V5\"\r\n            stroke=\"#999999\"\r\n            stroke-width=\"1.5\"\r\n            stroke-miterlimit=\"10\"\r\n            stroke-linecap=\"round\"\r\n            stroke-linejoin=\"round\"\r\n          />\r\n          <path\r\n            d=\"M3.5 9.08984H20.5\"\r\n            stroke=\"#999999\"\r\n            stroke-width=\"1.5\"\r\n            stroke-miterlimit=\"10\"\r\n            stroke-linecap=\"round\"\r\n            stroke-linejoin=\"round\"\r\n          />\r\n          <path\r\n            d=\"M21 8.5V17C21 20 19.5 22 16 22H8C4.5 22 3 20 3 17V8.5C3 5.5 4.5 3.5 8 3.5H16C19.5 3.5 21 5.5 21 8.5Z\"\r\n            stroke=\"#999999\"\r\n            stroke-width=\"1.5\"\r\n            stroke-miterlimit=\"10\"\r\n            stroke-linecap=\"round\"\r\n            stroke-linejoin=\"round\"\r\n          />\r\n          <path\r\n            d=\"M15.6947 13.7002H15.7037\"\r\n            stroke=\"#999999\"\r\n            stroke-width=\"2\"\r\n            stroke-linecap=\"round\"\r\n            stroke-linejoin=\"round\"\r\n          />\r\n          <path\r\n            d=\"M15.6947 16.7002H15.7037\"\r\n            stroke=\"#999999\"\r\n            stroke-width=\"2\"\r\n            stroke-linecap=\"round\"\r\n            stroke-linejoin=\"round\"\r\n          />\r\n          <path\r\n            d=\"M11.9955 13.7002H12.0045\"\r\n            stroke=\"#999999\"\r\n            stroke-width=\"2\"\r\n            stroke-linecap=\"round\"\r\n            stroke-linejoin=\"round\"\r\n          />\r\n          <path\r\n            d=\"M11.9955 16.7002H12.0045\"\r\n            stroke=\"#999999\"\r\n            stroke-width=\"2\"\r\n            stroke-linecap=\"round\"\r\n            stroke-linejoin=\"round\"\r\n          />\r\n          <path\r\n            d=\"M8.29431 13.7002H8.30329\"\r\n            stroke=\"#999999\"\r\n            stroke-width=\"2\"\r\n            stroke-linecap=\"round\"\r\n            stroke-linejoin=\"round\"\r\n          />\r\n          <path\r\n            d=\"M8.29431 16.7002H8.30329\"\r\n            stroke=\"#999999\"\r\n            stroke-width=\"2\"\r\n            stroke-linecap=\"round\"\r\n            stroke-linejoin=\"round\"\r\n          />\r\n        </svg>\r\n      </span>\r\n    </div>\r\n\r\n    @if(showCalendarForm && !disabled) {\r\n    <div\r\n      [class]=\"'calendar-popup ' + calendarPopUpClass\"\r\n      #calendarPopUpForm\r\n      [clickOutside]=\"calendarPopUpForm\"\r\n      (clickOutsideEmitter)=\"closeCalendar()\"\r\n    >\r\n      <div class=\"calendar-header\">\r\n        <button type=\"button\" class=\"nav-button\" (click)=\"prevMonth()\">\r\n          <svg\r\n            width=\"8\"\r\n            height=\"12\"\r\n            viewBox=\"0 0 8 12\"\r\n            fill=\"none\"\r\n            xmlns=\"http://www.w3.org/2000/svg\"\r\n          >\r\n            <path\r\n              d=\"M6.5 11L1.5 6L6.5 1\"\r\n              stroke=\"black\"\r\n              stroke-opacity=\"0.72\"\r\n              stroke-width=\"1.66667\"\r\n              stroke-linecap=\"round\"\r\n              stroke-linejoin=\"round\"\r\n            />\r\n          </svg>\r\n        </button>\r\n        <div class=\"month-title\">{{ getMonthName() }} {{ getYear() }}</div>\r\n        <button type=\"button\" class=\"nav-button\" (click)=\"nextMonth()\">\r\n          <svg\r\n            width=\"8\"\r\n            height=\"12\"\r\n            viewBox=\"0 0 8 12\"\r\n            fill=\"none\"\r\n            xmlns=\"http://www.w3.org/2000/svg\"\r\n          >\r\n            <path\r\n              d=\"M1.5 11L6.5 6L1.5 1\"\r\n              stroke=\"black\"\r\n              stroke-opacity=\"0.72\"\r\n              stroke-width=\"1.66667\"\r\n              stroke-linecap=\"round\"\r\n              stroke-linejoin=\"round\"\r\n            />\r\n          </svg>\r\n        </button>\r\n      </div>\r\n\r\n      <div class=\"weekdays\">\r\n        @for(weekday of weekdays; track weekday) {\r\n        <div class=\"weekday\">{{ weekday }}</div>\r\n        }\r\n      </div>\r\n\r\n      <div class=\"days-grid\">\r\n        @for(day of days; track day) {\r\n        <div\r\n          class=\"day\"\r\n          [class.current-month]=\"isCurrentMonth(day)\"\r\n          [class.selected]=\"isSelected(day)\"\r\n          [class.disabled]=\"isDisabled(day) || disabled\"\r\n          (click)=\"\r\n            $event.stopPropagation();\r\n            !isDisabled(day) && !disabled && selectDate(day)\r\n          \"\r\n        >\r\n          {{ day.getDate() }}\r\n        </div>\r\n        }\r\n      </div>\r\n    </div>\r\n    }\r\n  </div>\r\n</div>\r\n", styles: [".custom-calendar-container{position:relative;width:100%}.fullWidth{width:100%}.custom-label{display:block;font-size:1em;font-weight:500;color:#707070;margin-bottom:.3em}.custom-calendar-input{position:relative;height:var(--height);width:100%;border:1px solid #82828233;border-radius:6px;padding:0 12px;display:flex;align-items:center;cursor:pointer;background-color:#fff}.custom-calendar-input.has-error{border:1px solid #e55658;box-shadow:1px 0 6px #e5565826}.placeholder{color:#82828250;font-size:.95em}.calendar-icon{position:absolute;right:12px;height:calc(var(--height) / 2.4)}.calendar-popup{position:absolute;top:100%;left:0;right:0;max-height:300px;overflow-y:auto;background-color:#fff;border:1px solid #82828233;border-radius:.375em;margin-top:4px;padding:1rem;z-index:10;box-shadow:0 4px 6px #0000001a}.calendar-header{display:flex;justify-content:space-between;align-items:center;margin-bottom:12px}.month-title{font-weight:600}.nav-button{background:none;border:none;font-size:16px;cursor:pointer;padding:4px 8px}.weekdays{display:grid;grid-template-columns:repeat(7,1fr);text-align:center;font-weight:500;font-size:12px;margin-bottom:8px}.days-grid{display:grid;grid-template-columns:repeat(7,1fr);gap:4px}.day{height:32px;display:flex;align-items:center;justify-content:center;border-radius:4px;cursor:pointer;font-size:14px}.day.current-month{color:#111827}.day:not(.current-month){color:#9ca3af}.day.selected{background-color:#602650;color:#fff}.day.disabled{color:#d1d5db;cursor:not-allowed;text-decoration:line-through}.day:not(.disabled):not(.selected):hover{background-color:#f3f4f6}.custom-calendar-input.disabled{background:#f3f3f3;color:#b0b0b0;cursor:not-allowed;border-color:#e0e0e0}.calendar-error-container{position:absolute;top:100%;left:.73em;width:100%}.calendar-error-container custom-app-error{pointer-events:none}\n"], dependencies: [{ kind: "component", type: CustomAppErrorComponent, selector: "custom-app-error", inputs: ["control", "validation", "name", "showErrors"] }, { kind: "directive", type: ClickOutsideDirective, selector: "[clickOutside]", inputs: ["clickOutside"], outputs: ["clickOutsideEmitter"] }, { kind: "ngmodule", type: ReactiveFormsModule }, { kind: "directive", type: i1$2.NgControlStatusGroup, selector: "[formGroupName],[formArrayName],[ngModelGroup],[formGroup],form:not([ngNoForm]),[ngForm]" }, { kind: "directive", type: i1$2.FormGroupDirective, selector: "[formGroup]", inputs: ["formGroup"], outputs: ["ngSubmit"], exportAs: ["ngForm"] }, { kind: "ngmodule", type: CommonModule }, { kind: "directive", type: i2.NgIf, selector: "[ngIf]", inputs: ["ngIf", "ngIfThen", "ngIfElse"] }, { kind: "directive", type: i2.NgStyle, selector: "[ngStyle]", inputs: ["ngStyle"] }] });
}
...
class CustomInputFormComponent {
    ...
    static ɵcmp = i0.ɵɵngDeclareComponent({ minVersion: "17.0.0", version: "19.2.14", type: CustomInputFormComponent, isStandalone: true, selector: "custom-input-form", inputs: { class: "class", labelClass: "labelClass", label: "label", placeholder: "placeholder", name: "name", type: "type", controlName: "controlName", parentForm: "parentForm", validation: "validation", pattern: "pattern", height: "height" }, outputs: { valueChange: "valueChange" }, ngImport: i0, template: "<div style=\"width: 100%\" [formGroup]=\"parentForm\" class=\"input-wrapper\">\r\n  @if(label){\r\n  <label [for]=\"label\" [class]=\"'custom-label ' + labelClass\">\r\n    {{ label }}\r\n\r\n    @if(containRequiredError()){\r\n    <span style=\"color: #f43f5e; font-size: 15px; font-weight: 500\">*</span>\r\n    } @else{\r\n    <span style=\"color: #f43f5e; font-size: 15px; font-weight: 500\"\r\n      >&nbsp;</span\r\n    >\r\n    }\r\n  </label>\r\n  }\r\n\r\n  <div\r\n    class=\"input-container\"\r\n    [class.has-error]=\"\r\n      parentForm.controls[controlName].invalid &&\r\n      parentForm.controls[controlName].touched\r\n    \"\r\n    [ngStyle]=\"{ '--height': height }\"\r\n  >\r\n    <div class=\"input-error-container\">\r\n      @if( parentForm.controls[controlName].invalid &&\r\n      parentForm.controls[controlName].touched ){\r\n      <custom-app-error\r\n        [control]=\"parentForm.controls[controlName]\"\r\n        [validation]=\"validation\"\r\n        [name]=\"name\"\r\n      />\r\n      }\r\n    </div>\r\n\r\n    <input\r\n      [id]=\"label || name\"\r\n      [type]=\"type\"\r\n      [name]=\"name\"\r\n      [placeholder]=\"placeholder\"\r\n      [class]=\"'custom-input ' + class\"\r\n      [formControlName]=\"controlName\"\r\n      (ngModelChange)=\"valueChange.emit($event)\"\r\n      [pattern]=\"pattern\"\r\n      [style]=\"\r\n        parentForm.controls[controlName].invalid &&\r\n        parentForm.controls[controlName].touched\r\n          ? 'padding: 0.2em 4em 0.93em 1em;'\r\n          : 'padding: 0.2em 1em;'\r\n      \"\r\n      [class.input-error]=\"\r\n        parentForm.controls[controlName].invalid &&\r\n        parentForm.controls[controlName].touched\r\n      \"\r\n    />\r\n    <!-- Error icon (SVG) -->\r\n    @if( parentForm.controls[controlName].invalid &&\r\n    parentForm.controls[controlName].touched ){\r\n    <span class=\"input-icon\"\r\n      ><svg\r\n        width=\"1.08em\"\r\n        height=\"1.08em\"\r\n        viewBox=\"0 0 22 22\"\r\n        fill=\"none\"\r\n        xmlns=\"http://www.w3.org/2000/svg\"\r\n      >\r\n        <g clip-path=\"url(#clip0_9085_34629)\">\r\n          <path\r\n            d=\"M11 21C16.5228 21 21 16.5228 21 11C21 5.47715 16.5228 1 11 1C5.47715 1 1 5.47715 1 11C1 16.5228 5.47715 21 11 21Z\"\r\n            stroke=\"#EB0000\"\r\n            stroke-width=\"1.3\"\r\n            stroke-linecap=\"round\"\r\n            stroke-linejoin=\"round\"\r\n          />\r\n          <path\r\n            d=\"M11 7V11\"\r\n            stroke=\"#EB0000\"\r\n            stroke-width=\"1.3\"\r\n            stroke-linecap=\"round\"\r\n            stroke-linejoin=\"round\"\r\n          />\r\n          <path\r\n            d=\"M11 15H11.01\"\r\n            stroke=\"#EB0000\"\r\n            stroke-width=\"1.3\"\r\n            stroke-linecap=\"round\"\r\n            stroke-linejoin=\"round\"\r\n          />\r\n        </g>\r\n        <defs>\r\n          <clipPath id=\"clip0_9085_34629\">\r\n            <rect width=\"22\" height=\"22\" fill=\"white\" />\r\n          </clipPath>\r\n        </defs>\r\n      </svg>\r\n    </span>\r\n    }\r\n  </div>\r\n</div>\r\n", styles: [".input-wrapper{position:relative}.input-container{position:relative;height:var(--height)}.custom-input{height:100%;width:100%;border-radius:.375em;border:1px solid #82828233;outline:none!important;box-shadow:none;font-size:1em;font-weight:400;transition:border-color .2s}.custom-input.input-error{border:1px solid #e55658;box-shadow:1px 0 6px #e5565826}.input-icon{position:absolute;right:1em;top:50%;transform:translateY(-50%);color:#e55658;font-size:1.5em;pointer-events:none}.custom-input::placeholder{color:#82828233;font-size:1em;font-weight:400}.custom-label{font-size:1em;font-weight:500;display:block;color:#707070;margin-bottom:.3em}.input-error-container{position:absolute;top:100%;left:0;width:100%}.input-error-container custom-app-error{pointer-events:none}input[type=password]::-ms-reveal{display:none!important}input[type=password]::-ms-clear{display:none!important}\n"], dependencies: [{ kind: "directive", type: NgStyle, selector: "[ngStyle]", inputs: ["ngStyle"] }, { kind: "ngmodule", type: ReactiveFormsModule }, { kind: "directive", type: i1$2.DefaultValueAccessor, selector: "input:not([type=checkbox])[formControlName],textarea[formControlName],input:not([type=checkbox])[formControl],textarea[formControl],input:not([type=checkbox])[ngModel],textarea[ngModel],[ngDefaultControl]" }, { kind: "directive", type: i1$2.NgControlStatus, selector: "[formControlName],[ngModel],[formControl]" }, { kind: "directive", type: i1$2.NgControlStatusGroup, selector: "[formGroupName],[formArrayName],[ngModelGroup],[formGroup],form:not([ngNoForm]),[ngForm]" }, { kind: "directive", type: i1$2.PatternValidator, selector: "[pattern][formControlName],[pattern][formControl],[pattern][ngModel]", inputs: ["pattern"] }, { kind: "directive", type: i1$2.FormGroupDirective, selector: "[formGroup]", inputs: ["formGroup"], outputs: ["ngSubmit"], exportAs: ["ngForm"] }, { kind: "directive", type: i1$2.FormControlName, selector: "[formControlName]", inputs: ["formControlName", "disabled", "ngModel"], outputs: ["ngModelChange"] }, { kind: "component", type: CustomAppErrorComponent, selector: "custom-app-error", inputs: ["control", "validation", "name", "showErrors"] }] });
}
i0.ɵɵngDeclareClassMetadata({ minVersion: "12.0.0", version: "19.2.14", ngImport: i0, type: CustomInputFormComponent, decorators: [{
            type: Component,
            args: [{ selector: 'custom-input-form', standalone: true, imports: [NgStyle, ReactiveFormsModule, CustomAppErrorComponent], template: "<div style=\"width: 100%\" [formGroup]=\"parentForm\" class=\"input-wrapper\">\r\n  @if(label){\r\n  <label [for]=\"label\" [class]=\"'custom-label ' + labelClass\">\r\n    {{ label }}\r\n\r\n    @if(containRequiredError()){\r\n    <span style=\"color: #f43f5e; font-size: 15px; font-weight: 500\">*</span>\r\n    } @else{\r\n    <span style=\"color: #f43f5e; font-size: 15px; font-weight: 500\"\r\n      >&nbsp;</span\r\n    >\r\n    }\r\n  </label>\r\n  }\r\n\r\n  <div\r\n    class=\"input-container\"\r\n    [class.has-error]=\"\r\n      parentForm.controls[controlName].invalid &&\r\n      parentForm.controls[controlName].touched\r\n    \"\r\n    [ngStyle]=\"{ '--height': height }\"\r\n  >\r\n    <div class=\"input-error-container\">\r\n      @if( parentForm.controls[controlName].invalid &&\r\n      parentForm.controls[controlName].touched ){\r\n      <custom-app-error\r\n        [control]=\"parentForm.controls[controlName]\"\r\n        [validation]=\"validation\"\r\n        [name]=\"name\"\r\n      />\r\n      }\r\n    </div>\r\n\r\n    <input\r\n      [id]=\"label || name\"\r\n      [type]=\"type\"\r\n      [name]=\"name\"\r\n      [placeholder]=\"placeholder\"\r\n      [class]=\"'custom-input ' + class\"\r\n      [formControlName]=\"controlName\"\r\n      (ngModelChange)=\"valueChange.emit($event)\"\r\n      [pattern]=\"pattern\"\r\n      [style]=\"\r\n        parentForm.controls[controlName].invalid &&\r\n        parentForm.controls[controlName].touched\r\n          ? 'padding: 0.2em 4em 0.93em 1em;'\r\n          : 'padding: 0.2em 1em;'\r\n      \"\r\n      [class.input-error]=\"\r\n        parentForm.controls[controlName].invalid &&\r\n        parentForm.controls[controlName].touched\r\n      \"\r\n    />\r\n    <!-- Error icon (SVG) -->\r\n    @if( parentForm.controls[controlName].invalid &&\r\n    parentForm.controls[controlName].touched ){\r\n    <span class=\"input-icon\"\r\n      ><svg\r\n        width=\"1.08em\"\r\n        height=\"1.08em\"\r\n        viewBox=\"0 0 22 22\"\r\n        fill=\"none\"\r\n        xmlns=\"http://www.w3.org/2000/svg\"\r\n      >\r\n        <g clip-path=\"url(#clip0_9085_34629)\">\r\n          <path\r\n            d=\"M11 21C16.5228 21 21 16.5228 21 11C21 5.47715 16.5228 1 11 1C5.47715 1 1 5.47715 1 11C1 16.5228 5.47715 21 11 21Z\"\r\n            stroke=\"#EB0000\"\r\n            stroke-width=\"1.3\"\r\n            stroke-linecap=\"round\"\r\n            stroke-linejoin=\"round\"\r\n          />\r\n          <path\r\n            d=\"M11 7V11\"\r\n            stroke=\"#EB0000\"\r\n            stroke-width=\"1.3\"\r\n            stroke-linecap=\"round\"\r\n            stroke-linejoin=\"round\"\r\n          />\r\n          <path\r\n            d=\"M11 15H11.01\"\r\n            stroke=\"#EB0000\"\r\n            stroke-width=\"1.3\"\r\n            stroke-linecap=\"round\"\r\n            stroke-linejoin=\"round\"\r\n          />\r\n        </g>\r\n        <defs>\r\n          <clipPath id=\"clip0_9085_34629\">\r\n            <rect width=\"22\" height=\"22\" fill=\"white\" />\r\n          </clipPath>\r\n        </defs>\r\n      </svg>\r\n    </span>\r\n    }\r\n  </div>\r\n</div>\r\n", styles: [".input-wrapper{position:relative}.input-container{position:relative;height:var(--height)}.custom-input{height:100%;width:100%;border-radius:.375em;border:1px solid #82828233;outline:none!important;box-shadow:none;font-size:1em;font-weight:400;transition:border-color .2s}.custom-input.input-error{border:1px solid #e55658;box-shadow:1px 0 6px #e5565826}.input-icon{position:absolute;right:1em;top:50%;transform:translateY(-50%);color:#e55658;font-size:1.5em;pointer-events:none}.custom-input::placeholder{color:#82828233;font-size:1em;font-weight:400}.custom-label{font-size:1em;font-weight:500;display:block;color:#707070;margin-bottom:.3em}.input-error-container{position:absolute;top:100%;left:0;width:100%}.input-error-container custom-app-error{pointer-events:none}input[type=password]::-ms-reveal{display:none!important}input[type=password]::-ms-clear{display:none!important}\n"] }]
        }], propDecorators: { class: [{
                type: Input
            }], labelClass: [{
                type: Input
...
class CustomMultiSelectFormComponent {
    ...
    static ɵcmp = i0.ɵɵngDeclareComponent({ minVersion: "17.0.0", version: "19.2.14", type: CustomMultiSelectFormComponent, isStandalone: true, selector: "custom-multi-select-form", inputs: { parentForm: "parentForm", controlName: "controlName", label: "label", labelClass: "labelClass", dropdownOptionsClass: "dropdownOptionsClass", dropdownHeaderClass: "dropdownHeaderClass", dropdownContainerClass: "dropdownContainerClass", placeholder: "placeholder", enableFilter: "enableFilter", filterDesign: "filterDesign", showClear: "showClear", options: "options", name: "name", validation: "validation", height: "height", reset: "reset" }, ngImport: i0, template: "<div style=\"width: 100% ;font-size: 1em;\" [formGroup]=\"parentForm\">\r\n  @if(label){\r\n  <label [for]=\"label\" [class]=\"'custom-label ' + labelClass\">\r\n    {{ label }}\r\n\r\n    @if(containRequiredError()){\r\n    <span style=\"color: #f43f5e; font-size: 15px; font-weight: 500\">*</span>\r\n    } @else{\r\n    <span style=\"color: #f43f5e; font-size: 15px; font-weight: 500\"\r\n      >&nbsp;</span\r\n    >\r\n    }\r\n  </label>\r\n  }\r\n  <div [class]=\"'dropdown-container ' + dropdownContainerClass\">\r\n    <div class=\"dropdown-error-container\">\r\n      <custom-app-error\r\n        [control]=\"parentForm.controls[controlName]\"\r\n        [validation]=\"validation\"\r\n        [name]=\"name\"\r\n      />\r\n    </div>\r\n    <div\r\n      [class]=\"'dropdown-header ' + dropdownHeaderClass\"\r\n      (click)=\"toggleDropdown()\"\r\n      [class.has-error]=\"\r\n        parentForm.controls[controlName].invalid &&\r\n        parentForm.controls[controlName].touched\r\n      \"\r\n      [ngStyle]=\"{ '--height': height }\"\r\n    >\r\n      <div class=\"selected-option-container\">\r\n        @if (selectedOptions.length > 0) { @for (opt of selectedOptions; track\r\n        opt){\r\n        <span class=\"selected-tag\" [ngClass]=\"{ 'filter-tag': filterDesign }\">\r\n          <p style=\"color: #fff\">{{ opt.nameEn }}</p>\r\n          <span\r\n            class=\"remove-tag\"\r\n            (click)=\"$event.stopPropagation(); toggleOptionSelection(opt)\"\r\n            ><svg\r\n              width=\"8\"\r\n              height=\"8\"\r\n              viewBox=\"0 0 8 8\"\r\n              fill=\"none\"\r\n              xmlns=\"http://www.w3.org/2000/svg\"\r\n            >\r\n              <g clip-path=\"url(#clip0_9203_8209)\">\r\n                <path\r\n                  d=\"M7.42843 0.571289L0.571289 7.42843\"\r\n                  stroke=\"white\"\r\n                  stroke-linecap=\"round\"\r\n                  stroke-linejoin=\"round\"\r\n                />\r\n                <path\r\n                  d=\"M0.571289 0.571289L7.42843 7.42843\"\r\n                  stroke=\"white\"\r\n                  stroke-linecap=\"round\"\r\n                  stroke-linejoin=\"round\"\r\n                />\r\n              </g>\r\n              <defs>\r\n                <clipPath id=\"clip0_9203_8209\">\r\n                  <rect width=\"8\" height=\"8\" fill=\"white\" />\r\n                </clipPath>\r\n              </defs>\r\n            </svg>\r\n          </span>\r\n        </span>\r\n        } } @else {\r\n        <span class=\"selected-value placeholder\">\r\n          {{ placeholder }}\r\n        </span>\r\n        }\r\n      </div>\r\n      <div class=\"dropdown-icons\">\r\n        @if(selectedOptions.length > 0 && showClear){\r\n        <span class=\"clear-icon\" (click)=\"clearSelection($event)\">\r\n          <svg\r\n            width=\"inherit\"\r\n            height=\"inherit\"\r\n            viewBox=\"0 0 17 17\"\r\n            fill=\"none\"\r\n            xmlns=\"http://www.w3.org/2000/svg\"\r\n          >\r\n            <g clip-path=\"url(#clip0_30_1710)\">\r\n              <path\r\n                d=\"M15.0539 1.8631L1.69678 15.2202\"\r\n                stroke=\"#999999\"\r\n                stroke-width=\"2\"\r\n                stroke-linecap=\"round\"\r\n                stroke-linejoin=\"round\"\r\n              />\r\n              <path\r\n                d=\"M1.69678 1.8631L15.0539 15.2202\"\r\n                stroke=\"#999999\"\r\n                stroke-width=\"2\"\r\n                stroke-linecap=\"round\"\r\n                stroke-linejoin=\"round\"\r\n              />\r\n            </g>\r\n          </svg>\r\n        </span>\r\n        }\r\n        <svg\r\n          style=\"min-height: 12px\"\r\n          width=\"inherit\"\r\n          height=\"inherit\"\r\n          viewBox=\"0 0 17 16\"\r\n          fill=\"none\"\r\n          xmlns=\"http://www.w3.org/2000/svg\"\r\n        >\r\n          <path\r\n            d=\"M14.5 5.5L9.56061 11.0118C8.97727 11.6627 8.02273 11.6627 7.43939 11.0118L2.5 5.5\"\r\n            stroke=\"#999999\"\r\n            stroke-miterlimit=\"10\"\r\n            stroke-linecap=\"round\"\r\n            stroke-linejoin=\"round\"\r\n          />\r\n        </svg>\r\n      </div>\r\n    </div>\r\n\r\n    @if(isOpen){\r\n    <div\r\n      #dropdownOptionsMultiSelectForm\r\n      [class]=\"'dropdown-options ' + dropdownOptionsClass\"\r\n      [clickOutside]=\"dropdownOptionsMultiSelectForm\"\r\n      (clickOutsideEmitter)=\"closeDropdown()\"\r\n    >\r\n      @if(enableFilter){\r\n      <div class=\"filter-container\">\r\n        <div class=\"search-icon\">\r\n          <svg\r\n            width=\"auto\"\r\n            height=\"18\"\r\n            viewBox=\"0 0 18 18\"\r\n            fill=\"none\"\r\n            xmlns=\"http://www.w3.org/2000/svg\"\r\n          >\r\n            <path\r\n              d=\"M8.45536 15.3748C12.1718 15.3748 15.1845 12.3621 15.1845 8.64567C15.1845 4.92925 12.1718 1.9165 8.45536 1.9165C4.73895 1.9165 1.7262 4.92925 1.7262 8.64567C1.7262 12.3621 4.73895 15.3748 8.45536 15.3748Z\"\r\n              stroke=\"#292D32\"\r\n              stroke-width=\"1.5\"\r\n              stroke-linecap=\"round\"\r\n              stroke-linejoin=\"round\"\r\n            />\r\n            <path\r\n              d=\"M15.8929 16.0832L14.4762 14.6665\"\r\n              stroke=\"#292D32\"\r\n              stroke-width=\"1.5\"\r\n              stroke-linecap=\"round\"\r\n              stroke-linejoin=\"round\"\r\n            />\r\n          </svg>\r\n        </div>\r\n        <input\r\n          type=\"text\"\r\n          class=\"filter-input\"\r\n          placeholder=\"Search\"\r\n          #filterInput\r\n          (input)=\"filterText = filterInput.value; filterOptions()\"\r\n        />\r\n      </div>\r\n      }\r\n\r\n      <div class=\"options-list\">\r\n        @for(option of filteredOptions; track option.id){\r\n        <label\r\n          class=\"dropdown-option\"\r\n          [ngClass]=\"{ 'filter-design': filterDesign }\"\r\n        >\r\n          <input\r\n            type=\"checkbox\"\r\n            class=\"custom-checkbox\"\r\n            [checked]=\"isSelected(option.id)\"\r\n            (change)=\"toggleOptionSelection(option)\"\r\n          />\r\n          <span class=\"option-label\">{{ option.nameEn }}</span>\r\n        </label>\r\n        } @if(filteredOptions.length === 0){\r\n        <div class=\"no-options\">No options found</div>\r\n        }\r\n      </div>\r\n    </div>\r\n    }\r\n  </div>\r\n\r\n  <input\r\n    type=\"hidden\"\r\n    [id]=\"label\"\r\n    [name]=\"name\"\r\n    [formControlName]=\"controlName\"\r\n  />\r\n</div>\r\n", styles: [".dropdown-container{position:relative;width:100%}.dropdown-header{height:var(--height);width:100%;border-radius:.375em;border:1px solid #82828233;padding:0 1em;display:flex;align-items:center;justify-content:space-between;cursor:pointer;background-color:#fff}.dropdown-header.has-error{border:1px solid #e55658;box-shadow:1px 0 6px #e5565826}.remove-tag{cursor:pointer;padding:0 .3em;align-self:flex-start}.selected-option-container{display:flex;overflow-y:auto;max-height:100%;width:80%;flex-wrap:wrap}.selected-tag{display:flex;align-items:center;justify-content:space-between;gap:.2em;background-color:#25c7bc;color:#374151;font-size:.85em;border-radius:.375em;padding:.25em .01em .25em .5em;margin:2px}.selected-tag p{padding:.4em .05em .4em .4em}.remove-tag{padding:.2em .4em;cursor:pointer;font-weight:700}.selected-value{flex:1;overflow:hidden;text-overflow:ellipsis;white-space:nowrap;color:#374151;font-size:.95em}.placeholder{color:#82828250}.dropdown-icons{display:flex;align-items:center;gap:8px;height:calc(var(--height) / 3)}.clear-icon{color:#9ca3af;font-size:1.2rem;cursor:pointer;height:calc(var(--height) / 2)}.clear-icon:hover{color:#6b7280}.dropdown-options{position:absolute;top:100%;left:0;right:0;max-height:16em;overflow-y:auto;background-color:#fff;border:1px solid #82828233;border-radius:.375em;margin-top:4px;z-index:10;box-shadow:0 4px 6px #0000001a}.filter-container{margin:.5em;padding:.5em;border-bottom:1px solid #e5e7eb;display:flex;justify-content:start;align-items:center;font-size:1em}.search-icon{width:1.5em;opacity:40%;height:auto;margin-inline-end:.5em}.search-icon svg{width:100%!important;height:auto;display:block}.filter-input{padding:.3em;border-radius:.5em;border:none;color:#374151;width:75%;font-size:1.3em}.filter-input:focus,.filter-input:active,.filter-input:hover{border:none;outline:none}.options-list{padding:4px 0}.dropdown-option{padding:8px 16px;cursor:pointer}.dropdown-option.selected{background-color:#e5e7eb;font-weight:500}.no-options{padding:8px 16px;color:#9ca3af;font-style:italic}.custom-label{font-size:1em;font-weight:500;display:block;color:#707070;margin-bottom:.3em}.dropdown-option{display:flex;align-items:center;gap:12px;padding:10px 16px;cursor:pointer;transition:background-color .2s}.dropdown-option:hover{background-color:#e7f9f8}.filter-design{flex-direction:row-reverse;justify-content:space-between}.filter-tag{padding:.1em .01em .1em 1em;margin:2px;height:2em}.option-label{flex:1}.custom-checkbox{appearance:none;width:18px;height:18px;border:1.5px solid #9ca3af;border-radius:4px;background-color:#fff;display:inline-block;position:relative}.custom-checkbox:checked{background-color:#25c7bc;border-color:#25c7bc}.custom-checkbox:checked:after{content:\"\";position:absolute;top:2px;left:5px;width:5px;height:10px;border:solid white;border-width:0 2px 2px 0;transform:rotate(45deg)}.custom-checkbox:focus{border-color:#25c7bc}.dropdown-option.selected{background-color:#e5e7eb}.no-options{padding:12px 16px;color:#6b7280;font-style:italic;text-align:center}.dropdown-error-container{position:absolute;top:100%;left:.7em;width:100%}.dropdown-error-container custom-app-error{pointer-events:none}\n"], dependencies: [{ kind: "directive", type: NgStyle, selector: "[ngStyle]", inputs: ["ngStyle"] }, { kind: "ngmodule", type: FormsModule }, { kind: "directive", type: i1$2.DefaultValueAccessor, selector: "input:not([type=checkbox])[formControlName],textarea[formControlName],input:not([type=checkbox])[formControl],textarea[formControl],input:not([type=checkbox])[ngModel],textarea[ngModel],[ngDefaultControl]" }, { kind: "directive", type: i1$2.NgControlStatus, selector: "[formControlName],[ngModel],[formControl]" }, { kind: "directive", type: i1$2.NgControlStatusGroup, selector: "[formGroupName],[formArrayName],[ngModelGroup],[formGroup],form:not([ngNoForm]),[ngForm]" }, { kind: "ngmodule", type: ReactiveFormsModule }, { kind: "directive", type: i1$2.FormGroupDirective, selector: "[formGroup]", inputs: ["formGroup"], outputs: ["ngSubmit"], exportAs: ["ngForm"] }, { kind: "directive", type: i1$2.FormControlName, selector: "[formControlName]", inputs: ["formControlName", "disabled", "ngModel"], outputs: ["ngModelChange"] }, { kind: "directive", type: ClickOutsideDirective, selector: "[clickOutside]", inputs: ["clickOutside"], outputs: ["clickOutsideEmitter"] }, { kind: "component", type: CustomAppErrorComponent, selector: "custom-app-error", inputs: ["control", "validation", "name", "showErrors"] }, { kind: "directive", type: NgClass, selector: "[ngClass]", inputs: ["class", "ngClass"] }] });
}
i0.ɵɵngDeclareClassMetadata({ minVersion: "12.0.0", version: "19.2.14", ngImport: i0, type: CustomMultiSelectFormComponent, decorators: [{
            ...
            args: [{ selector: 'custom-multi-select-form', standalone: true, imports: [
                        ...
                        CustomAppErrorComponent,
                        NgClass,
                    ], template: "<div style=\"width: 100% ;font-size: 1em;\" [formGroup]=\"parentForm\">\r\n  @if(label){\r\n  <label [for]=\"label\" [class]=\"'custom-label ' + labelClass\">\r\n    {{ label }}\r\n\r\n    @if(containRequiredError()){\r\n    <span style=\"color: #f43f5e; font-size: 15px; font-weight: 500\">*</span>\r\n    } @else{\r\n    <span style=\"color: #f43f5e; font-size: 15px; font-weight: 500\"\r\n      >&nbsp;</span\r\n    >\r\n    }\r\n  </label>\r\n  }\r\n  <div [class]=\"'dropdown-container ' + dropdownContainerClass\">\r\n    <div class=\"dropdown-error-container\">\r\n      <custom-app-error\r\n        [control]=\"parentForm.controls[controlName]\"\r\n        [validation]=\"validation\"\r\n        [name]=\"name\"\r\n      />\r\n    </div>\r\n    <div\r\n      [class]=\"'dropdown-header ' + dropdownHeaderClass\"\r\n      (click)=\"toggleDropdown()\"\r\n      [class.has-error]=\"\r\n        parentForm.controls[controlName].invalid &&\r\n        parentForm.controls[controlName].touched\r\n      \"\r\n      [ngStyle]=\"{ '--height': height }\"\r\n    >\r\n      <div class=\"selected-option-container\">\r\n        @if (selectedOptions.length > 0) { @for (opt of selectedOptions; track\r\n        opt){\r\n        <span class=\"selected-tag\" [ngClass]=\"{ 'filter-tag': filterDesign }\">\r\n          <p style=\"color: #fff\">{{ opt.nameEn }}</p>\r\n          <span\r\n            class=\"remove-tag\"\r\n            (click)=\"$event.stopPropagation(); toggleOptionSelection(opt)\"\r\n            ><svg\r\n              width=\"8\"\r\n              height=\"8\"\r\n              viewBox=\"0 0 8 8\"\r\n              fill=\"none\"\r\n              xmlns=\"http://www.w3.org/2000/svg\"\r\n            >\r\n              <g clip-path=\"url(#clip0_9203_8209)\">\r\n                <path\r\n                  d=\"M7.42843 0.571289L0.571289 7.42843\"\r\n                  stroke=\"white\"\r\n                  stroke-linecap=\"round\"\r\n                  stroke-linejoin=\"round\"\r\n                />\r\n                <path\r\n                  d=\"M0.571289 0.571289L7.42843 7.42843\"\r\n                  stroke=\"white\"\r\n                  stroke-linecap=\"round\"\r\n                  stroke-linejoin=\"round\"\r\n                />\r\n              </g>\r\n              <defs>\r\n                <clipPath id=\"clip0_9203_8209\">\r\n                  <rect width=\"8\" height=\"8\" fill=\"white\" />\r\n                </clipPath>\r\n              </defs>\r\n            </svg>\r\n          </span>\r\n        </span>\r\n        } } @else {\r\n        <span class=\"selected-value placeholder\">\r\n          {{ placeholder }}\r\n        </span>\r\n        }\r\n      </div>\r\n      <div class=\"dropdown-icons\">\r\n        @if(selectedOptions.length > 0 && showClear){\r\n        <span class=\"clear-icon\" (click)=\"clearSelection($event)\">\r\n          <svg\r\n            width=\"inherit\"\r\n            height=\"inherit\"\r\n            viewBox=\"0 0 17 17\"\r\n            fill=\"none\"\r\n            xmlns=\"http://www.w3.org/2000/svg\"\r\n          >\r\n            <g clip-path=\"url(#clip0_30_1710)\">\r\n              <path\r\n                d=\"M15.0539 1.8631L1.69678 15.2202\"\r\n                stroke=\"#999999\"\r\n                stroke-width=\"2\"\r\n                stroke-linecap=\"round\"\r\n                stroke-linejoin=\"round\"\r\n              />\r\n              <path\r\n                d=\"M1.69678 1.8631L15.0539 15.2202\"\r\n                stroke=\"#999999\"\r\n                stroke-width=\"2\"\r\n                stroke-linecap=\"round\"\r\n                stroke-linejoin=\"round\"\r\n              />\r\n            </g>\r\n          </svg>\r\n        </span>\r\n        }\r\n        <svg\r\n          style=\"min-height: 12px\"\r\n          width=\"inherit\"\r\n          height=\"inherit\"\r\n          viewBox=\"0 0 17 16\"\r\n          fill=\"none\"\r\n          xmlns=\"http://www.w3.org/2000/svg\"\r\n        >\r\n          <path\r\n            d=\"M14.5 5.5L9.56061 11.0118C8.97727 11.6627 8.02273 11.6627 7.43939 11.0118L2.5 5.5\"\r\n            stroke=\"#999999\"\r\n            stroke-miterlimit=\"10\"\r\n            stroke-linecap=\"round\"\r\n            stroke-linejoin=\"round\"\r\n          />\r\n        </svg>\r\n      </div>\r\n    </div>\r\n\r\n    @if(isOpen){\r\n    <div\r\n      #dropdownOptionsMultiSelectForm\r\n      [class]=\"'dropdown-options ' + dropdownOptionsClass\"\r\n      [clickOutside]=\"dropdownOptionsMultiSelectForm\"\r\n      (clickOutsideEmitter)=\"closeDropdown()\"\r\n    >\r\n      @if(enableFilter){\r\n      <div class=\"filter-container\">\r\n        <div class=\"search-icon\">\r\n          <svg\r\n            width=\"auto\"\r\n            height=\"18\"\r\n            viewBox=\"0 0 18 18\"\r\n            fill=\"none\"\r\n            xmlns=\"http://www.w3.org/2000/svg\"\r\n          >\r\n            <path\r\n              d=\"M8.45536 15.3748C12.1718 15.3748 15.1845 12.3621 15.1845 8.64567C15.1845 4.92925 12.1718 1.9165 8.45536 1.9165C4.73895 1.9165 1.7262 4.92925 1.7262 8.64567C1.7262 12.3621 4.73895 15.3748 8.45536 15.3748Z\"\r\n              stroke=\"#292D32\"\r\n              stroke-width=\"1.5\"\r\n              stroke-linecap=\"round\"\r\n              stroke-linejoin=\"round\"\r\n            />\r\n            <path\r\n              d=\"M15.8929 16.0832L14.4762 14.6665\"\r\n              stroke=\"#292D32\"\r\n              stroke-width=\"1.5\"\r\n              stroke-linecap=\"round\"\r\n              stroke-linejoin=\"round\"\r\n            />\r\n          </svg>\r\n        </div>\r\n        <input\r\n          type=\"text\"\r\n          class=\"filter-input\"\r\n          placeholder=\"Search\"\r\n          #filterInput\r\n          (input)=\"filterText = filterInput.value; filterOptions()\"\r\n        />\r\n      </div>\r\n      }\r\n\r\n      <div class=\"options-list\">\r\n        @for(option of filteredOptions; track option.id){\r\n        <label\r\n          class=\"dropdown-option\"\r\n          [ngClass]=\"{ 'filter-design': filterDesign }\"\r\n        >\r\n          <input\r\n            type=\"checkbox\"\r\n            class=\"custom-checkbox\"\r\n            [checked]=\"isSelected(option.id)\"\r\n            (change)=\"toggleOptionSelection(option)\"\r\n          />\r\n          <span class=\"option-label\">{{ option.nameEn }}</span>\r\n        </label>\r\n        } @if(filteredOptions.length === 0){\r\n        <div class=\"no-options\">No options found</div>\r\n        }\r\n      </div>\r\n    </div>\r\n    }\r\n  </div>\r\n\r\n  <input\r\n    type=\"hidden\"\r\n    [id]=\"label\"\r\n    [name]=\"name\"\r\n    [formControlName]=\"controlName\"\r\n  />\r\n</div>\r\n", styles: [".dropdown-container{position:relative;width:100%}.dropdown-header{height:var(--height);width:100%;border-radius:.375em;border:1px solid #82828233;padding:0 1em;display:flex;align-items:center;justify-content:space-between;cursor:pointer;background-color:#fff}.dropdown-header.has-error{border:1px solid #e55658;box-shadow:1px 0 6px #e5565826}.remove-tag{cursor:pointer;padding:0 .3em;align-self:flex-start}.selected-option-container{display:flex;overflow-y:auto;max-height:100%;width:80%;flex-wrap:wrap}.selected-tag{display:flex;align-items:center;justify-content:space-between;gap:.2em;background-color:#25c7bc;color:#374151;font-size:.85em;border-radius:.375em;padding:.25em .01em .25em .5em;margin:2px}.selected-tag p{padding:.4em .05em .4em .4em}.remove-tag{padding:.2em .4em;cursor:pointer;font-weight:700}.selected-value{flex:1;overflow:hidden;text-overflow:ellipsis;white-space:nowrap;color:#374151;font-size:.95em}.placeholder{color:#82828250}.dropdown-icons{display:flex;align-items:center;gap:8px;height:calc(var(--height) / 3)}.clear-icon{color:#9ca3af;font-size:1.2rem;cursor:pointer;height:calc(var(--height) / 2)}.clear-icon:hover{color:#6b7280}.dropdown-options{position:absolute;top:100%;left:0;right:0;max-height:16em;overflow-y:auto;background-color:#fff;border:1px solid #82828233;border-radius:.375em;margin-top:4px;z-index:10;box-shadow:0 4px 6px #0000001a}.filter-container{margin:.5em;padding:.5em;border-bottom:1px solid #e5e7eb;display:flex;justify-content:start;align-items:center;font-size:1em}.search-icon{width:1.5em;opacity:40%;height:auto;margin-inline-end:.5em}.search-icon svg{width:100%!important;height:auto;display:block}.filter-input{padding:.3em;border-radius:.5em;border:none;color:#374151;width:75%;font-size:1.3em}.filter-input:focus,.filter-input:active,.filter-input:hover{border:none;outline:none}.options-list{padding:4px 0}.dropdown-option{padding:8px 16px;cursor:pointer}.dropdown-option.selected{background-color:#e5e7eb;font-weight:500}.no-options{padding:8px 16px;color:#9ca3af;font-style:italic}.custom-label{font-size:1em;font-weight:500;display:block;color:#707070;margin-bottom:.3em}.dropdown-option{display:flex;align-items:center;gap:12px;padding:10px 16px;cursor:pointer;transition:background-color .2s}.dropdown-option:hover{background-color:#e7f9f8}.filter-design{flex-direction:row-reverse;justify-content:space-between}.filter-tag{padding:.1em .01em .1em 1em;margin:2px;height:2em}.option-label{flex:1}.custom-checkbox{appearance:none;width:18px;height:18px;border:1.5px solid #9ca3af;border-radius:4px;background-color:#fff;display:inline-block;position:relative}.custom-checkbox:checked{background-color:#25c7bc;border-color:#25c7bc}.custom-checkbox:checked:after{content:\"\";position:absolute;top:2px;left:5px;width:5px;height:10px;border:solid white;border-width:0 2px 2px 0;transform:rotate(45deg)}.custom-checkbox:focus{border-color:#25c7bc}.dropdown-option.selected{background-color:#e5e7eb}.no-options{padding:12px 16px;color:#6b7280;font-style:italic;text-align:center}.dropdown-error-container{position:absolute;top:100%;left:.7em;width:100%}.dropdown-error-container custom-app-error{pointer-events:none}\n"] }]
        }], propDecorators: { parentForm: [{
                type: Input,
                args: [{ required: true }]
            }], controlName: [{
...
i0.ɵɵngDeclareClassMetadata({ minVersion: "12.0.0", version: "19.2.14", ngImport: i0, type: CustomTableComponent, decorators: [{
        ...
        }], ctorParameters: () => [{ type: i1$3.DomSanitizer }], propDecorators: { tableData: [{
                type: Input,
                args: [{ required: false }]
            }], tableCategories: [{
                type: Input,
...
i0.ɵɵngDeclareClassMetadata({ minVersion: "12.0.0", version: "19.2.14", ngImport: i0, type: CustomFileUploadComponent, decorators: [{
        ...
        }], ctorParameters: () => [{ type: i1$3.DomSanitizer }], propDecorators: { parentForm: [{
                type: Input,
                args: [{ required: true }]
            }], FileTypes: [{
                type: Input,
...
class CustomFileViewerComponent {
    ...
    static ɵfac = i0.ɵɵngDeclareFactory({ minVersion: "12.0.0", version: "19.2.14", ngImport: i0, type: CustomFileViewerComponent, deps: [{ token: i1$3.DomSanitizer }], target: i0.ɵɵFactoryTarget.Component });
...
i0.ɵɵngDeclareClassMetadata({ minVersion: "12.0.0", version: "19.2.14", ngImport: i0, type: CustomFileViewerComponent, decorators: [{
        ...
        }], ctorParameters: () => [{ type: i1$3.DomSanitizer }], propDecorators: { file: [{
                type: Input,
                args: [{ required: true }]
            }], showMenu: [{
                type: Input
...
class CustomSteppersContainerComponent {
    ...
    static ɵfac = i0.ɵɵngDeclareFactory({ minVersion: "12.0.0", version: "19.2.14", ngImport: i0, type: CustomSteppersContainerComponent, deps: [{ token: StepperService }, { token: i1$3.DomSanitizer }], target: i0.ɵɵFactoryTarget.Component });
...
i0.ɵɵngDeclareClassMetadata({ minVersion: "12.0.0", version: "19.2.14", ngImport: i0, type: CustomSteppersContainerComponent, decorators: [{
        ...
        }], ctorParameters: () => [{ type: StepperService }, { type: i1$3.DomSanitizer }], propDecorators: { steps: [{
                type: Input
            }] } });
...
i0.ɵɵngDeclareClassMetadata({ minVersion: "12.0.0", version: "19.2.14", ngImport: i0, type: CustomFieldsFormComponent, decorators: [{
        ...
        }], ctorParameters: () => [{ type: i1$2.FormBuilder }], propDecorators: { parentForm: [{
                type: Input,
                args: [{ required: true }]
            }], controlName: [{
                type: Input,
...
i0.ɵɵngDeclareClassMetadata({ minVersion: "12.0.0", version: "19.2.14", ngImport: i0, type: CustomDynamicTableWithCategoriesComponent, decorators: [{
            type: Component,
            args: [{ selector: 'custom-dynamic-table-with-categories', imports: [TranslateModule, NgClass, NgTemplateOutlet], template: "<div class=\"table-container\">\r\n\r\n  <table class=\"striped-table\">\r\n    <thead>\r\n      <tr>\r\n        @if(hasCheckBox){\r\n        <th>\r\n          <div class=\"check-box-container\">\r\n            <input id=\"checkbox\" class=\"custom-checkbox\" type=\"checkbox\" />\r\n          </div>\r\n        </th>\r\n\r\n        } @for(column of config.columns; track $index) {\r\n        <th>\r\n          <div class=\"table-header-cell\">\r\n            {{ column.label | translate }}\r\n            @if(column.sort){\r\n            <div\r\n              [innerHTML]=\"checkedSortIcon\"\r\n              class=\"sort-icon\"\r\n              (click)=\"sortColumn.emit(column)\"\r\n            ></div>\r\n            }\r\n          </div>\r\n        </th>\r\n\r\n        } @if(config.actions?.length) {\r\n\r\n        <th class=\"actions-width\">\r\n          <div class=\"table-header-cell\">\r\n            {{ \"Actions\" | translate }}\r\n          </div>\r\n        </th>\r\n        }\r\n      </tr>\r\n    </thead>\r\n    <tbody>\r\n      @if(config.groupedData?.length) { @for(group of config.groupedData; track\r\n      $index) {\r\n      <!-- Group Header -->\r\n      <tr (click)=\"group.isCollapsed = !group.isCollapsed\">\r\n        <td\r\n          class=\"group-header__wrapper\"\r\n          [attr.colspan]=\"\r\n            config.columns.length + (config.actions?.length ? 1 : 0)\r\n          \"\r\n        >\r\n          <div class=\"group-header__title-container\" style=\"cursor: pointer\">\r\n            <div\r\n              [ngClass]=\"{ rotated: group.isCollapsed }\"\r\n              [innerHTML]=\"expandSvg\"\r\n              class=\"group-header__expand-icon\"\r\n            ></div>\r\n            <p class=\"group-header__title\">\r\n              {{ group.title }} ({{ group.items.length }})\r\n            </p>\r\n          </div>\r\n        </td>\r\n      </tr>\r\n      <!-- Group Rows -->\r\n      @if(!group.isCollapsed) { @for(row of group.items; track $index) {\r\n      <tr>\r\n        <!-- Columns -->\r\n        <td>\r\n          <div class=\"check-box-container\">\r\n            <input id=\"checkbox\" class=\"custom-checkbox\" type=\"checkbox\" />\r\n          </div>\r\n        </td>\r\n        @for(col of config.columns; track $index) { @if(col.key === 'nameEn' ||\r\n        col.key === 'nameAr') {\r\n        <td\r\n          [style.background-color]=\"group.color\"\r\n          (click)=\"nameClick.emit(row)\"\r\n          [style.cursor]=\"'pointer'\"\r\n          style=\"min-width: 10em\"\r\n        >\r\n          <span style=\"font-size: 1em\">\r\n            {{ getNestedValue(row, col.key) }}\r\n          </span>\r\n        </td>\r\n\r\n        }@else {\r\n\r\n        <td [class]=\"col.customClass\">\r\n          @if(cellTemplates[col.key]) {\r\n          <ng-template\r\n            *ngTemplateOutlet=\"\r\n              cellTemplates[col.key];\r\n              context: { $implicit: row }\r\n            \"\r\n          >\r\n          </ng-template>\r\n          } @else {\r\n          <span\r\n            style=\"font-size: 1em\"\r\n            [ngClass]=\"{ 'no-wrap': col.key.toLowerCase().includes('date') }\"\r\n          >\r\n            {{ getNestedValue(row, col.key) }}\r\n          </span>\r\n          }\r\n        </td>\r\n        } }\r\n\r\n        <!-- Actions Column -->\r\n\r\n        <td>\r\n          <div class=\"action-buttons\">\r\n            @for ( action of config.actions; track $index) {\r\n            <!-- @if (actionTemplates[action.label]) {\r\n              <ng-template\r\n                *ngTemplateOutlet=\"\r\n                  actionTemplates[action.label];\r\n                  context: { $implicit: row }\r\n                \"\r\n              >\r\n              </ng-template>\r\n              } @else {} -->\r\n\r\n            <button\r\n              style=\"padding: 0.5em\"\r\n              [disabled]=\"action.isDisabled?.(row)\"\r\n              (click)=\"onAction(row, action.handler)\"\r\n            >\r\n              <img [src]=\"action.iconPath\" alt=\"\" />\r\n            </button>\r\n\r\n            }\r\n          </div>\r\n        </td>\r\n      </tr>\r\n      } } } }\r\n    </tbody>\r\n  </table>\r\n</div>\r\n", styles: [".table-container{overflow-x:auto;overflow-y:hidden;width:100%;max-width:100%}.striped-table{width:100%;min-width:1000px;background-color:#fff}.striped-table thead{color:#4b4b4b;text-align:left;font-size:1.1em}.striped-table th{padding:.6em .8em;border:1px solid #eeeeee}.striped-table tbody tr{font-weight:500;font-size:1em}.striped-table td{padding:.3em .5em;color:#4b4b4b;border:1px solid #eeeeee}.table-header-cell{display:flex;flex-direction:row;justify-content:flex-start;gap:.5em;align-items:center;font-size:.9em;color:#4b4b4b}.sort-icon{width:1em;height:auto}.sort-icon svg{width:100%!important;height:auto;display:block}.group-header__wrapper{border:none!important}.group-header__title-container{display:flex;align-items:center}.group-header__expand-icon{cursor:pointer;transition:transform .3s;width:1em;height:auto}.group-header__expand-icon svg{width:100%!important;height:auto;display:block}.rotated{transform:rotate(-180deg)}.group-header__title{margin-top:.8em;margin-bottom:.8em;font-size:1.1em;font-weight:900;margin-inline-start:.5em;color:#000}th:first-child,td:first-child{width:1%}.check-box-container{display:flex;justify-content:center}.custom-checkbox{appearance:none;width:1.2em;height:1.2em;border:1px solid #ccc;border-radius:.1em;position:relative;outline:none;cursor:pointer;transition:border-color .3s ease-in,background-color .3s ease-in}.custom-checkbox:focus{border-color:#25c7bc}.custom-checkbox:checked{background-color:#25c7bc;border-color:#25c7bc}.custom-checkbox:checked:after{content:\"\";position:absolute;top:10%;inset-inline-start:50%;transform:translate(-50%,-10%) rotate(45deg);width:.4em;height:.9em;border:solid white;border-width:0 .2em .2em 0}.custom-checkbox:disabled{cursor:not-allowed}.action-buttons{display:flex;gap:.5em}.bg-titles{background-color:#fcfbfb!important}.no-wrap{white-space:nowrap}\n"] }]
...
i0.ɵɵngDeclareClassMetadata({ minVersion: "12.0.0", version: "19.2.14", ngImport: i0, type: CustomDropdownButtonComponent, decorators: [{
        ...
        }], ctorParameters: () => [{ type: i1$3.DomSanitizer }], propDecorators: { options: [{
                type: Input,
                args: [{ required: true }]
            }], selected: [{
                type: Output
...
i0.ɵɵngDeclareClassMetadata({ minVersion: "12.0.0", version: "19.2.14", ngImport: i0, type: CustomDetailsHeaderComponent, decorators: [{
        ...
        }], ctorParameters: () => [{ type: i1$3.DomSanitizer }], propDecorators: { showX: [{
                type: Input
            }], BreadCrumbs: [{
                type: Input,
                args: [{ required: true }]
...
class CustomActionsDropdownComponent {
    ...
    static ɵfac = i0.ɵɵngDeclareFactory({ minVersion: "12.0.0", version: "19.2.14", ngImport: i0, type: CustomActionsDropdownComponent, deps: [{ token: i1$3.DomSanitizer }], target: i0.ɵɵFactoryTarget.Component });
    static ɵcmp = i0.ɵɵngDeclareComponent({ minVersion: "17.0.0", version: "19.2.14", type: CustomActionsDropdownComponent, isStandalone: true, selector: "custom-actions-dropdown", inputs: { actions: "actions", context: "context" }, ngImport: i0, template: "\r\n\r\n  <div\r\n\r\n    class=\"action-dropdown\" (mouseenter)=\"openDropdown()\" (mouseleave)=\"closeDropdown()\"\r\n\r\n  >\r\n\r\n    <div  class=\"mutlti-action-icon\">\r\n      <svg xmlns=\"http://www.w3.org/2000/svg\" width=\"4\" height=\"12\" viewBox=\"0 0 4 12\" fill=\"none\">\r\n  <path d=\"M0.666707 1.33333C0.666707 2.06971 1.26366 2.66667 2.00004 2.66667C2.73642 2.66667 3.33337 2.06971 3.33337 1.33333C3.33337 0.596954 2.73642 -2.60937e-08 2.00004 -5.82819e-08C1.26366 -9.047e-08 0.666707 0.596954 0.666707 1.33333Z\" fill=\"#8E8E8E\"/>\r\n  <path d=\"M2.00004 7.33333C1.26366 7.33333 0.666707 6.73638 0.666707 6C0.666707 5.26362 1.26366 4.66667 2.00004 4.66667C2.73642 4.66667 3.33337 5.26362 3.33337 6C3.33337 6.73638 2.73642 7.33333 2.00004 7.33333Z\" fill=\"#8E8E8E\"/>\r\n  <path d=\"M2.00004 12C1.26366 12 0.666707 11.403 0.666707 10.6667C0.666707 9.93029 1.26366 9.33333 2.00004 9.33333C2.73642 9.33333 3.33337 9.93029 3.33337 10.6667C3.33337 11.403 2.73642 12 2.00004 12Z\" fill=\"#8E8E8E\"/>\r\n  </svg>\r\n    </div>\r\n\r\n    @if(isOpen && actions.length>0){\r\n\r\n    <div class=\"dropdown-menu\"   >\r\n      <ul>\r\n        @for(action of actions ;track $index){\r\n\r\n        <li class=\"dropdown-item\" (click)=\"onClickAction(action)\">\r\n          <span class=\"action-icon-inline\"  [innerHTML]=\"sanitizeSvg(action.icon)\"></span>\r\n          <span class=\"action-label\">{{ action.label }}</span>\r\n        </li>\r\n        }\r\n      </ul>\r\n    </div>\r\n    }\r\n  </div>\r\n\r\n", styles: [".action-dropdown{position:relative}.mutlti-action-icon{width:1.25em;height:1.25em;cursor:pointer;opacity:85%}.dropdown-menu{position:absolute;top:100%;inset-inline-end:0;background-color:#fff;border:1px solid #d1d5db;box-shadow:0 4px 6px #0000001a;border-radius:.2em;z-index:9999;padding:.25em 0}.dropdown-item{display:flex;align-items:center;padding:.5em .8em;font-size:.8em;cursor:pointer;transition:background-color .2s;color:#06213d;background-color:#fff}.dropdown-item:hover{background-color:#f3f4f6}.action-icon-inline{display:inline-flex;align-items:center;justify-content:center;margin-inline-end:.5em;width:1.2em;height:1.2em}.action-icon-inline svg{width:100%;height:100%;fill:currentColor}\n"] });
}
i0.ɵɵngDeclareClassMetadata({ minVersion: "12.0.0", version: "19.2.14", ngImport: i0, type: CustomActionsDropdownComponent, decorators: [{
        ...
        }], ctorParameters: () => [{ type: i1$3.DomSanitizer }], propDecorators: { actions: [{
                type: Input
            }], context: [{
                type: Input
            }] } });
...
class CustomFilterDropdownComponent {
    ...
    ngOnInit() {
        ...
        main.forEach((row) => {
            if (row.filterConfig) {
                const initialValue = filteredValues[row.filterConfig.nameEn] ??
                ...
                this.filterForm.addControl(row.filterConfig.nameEn, new FormControl(initialValue, validators));
            }
        });
    ...
    addFilterRow() {
        this.activeFilters.update((current) => ({
            ...current,
            main: [...current.main, { controlName: `row_${Date.now()}` }],
        }));
    }
    onFilterDropdownChange(selectedId, rowIndex) {
        console.log(selectedId, rowIndex);
        if (!selectedId)
            return;
        ...
        if (!this.filterForm.contains(row.filterConfig.nameEn)) {
            let control;
            switch (row.filterConfig.type) {
                case 'multiselect':
            ...
            this.filterForm.addControl(row.filterConfig.nameEn, control);
    ...
    removeFilterRow(rowIndex) {
        ...
        if (row &&
            row.filterConfig &&
            this.filterForm.contains(row.filterConfig.nameEn)) {
            this.filterForm.get(row.filterConfig.nameEn)?.reset();
            this.filterForm.removeControl(row.controlName);
        }
    ...
    clearAll() {
        ...
        // console.log(this.activeFilters().main);
        // for (let i = 0; i <= this.activeFilters().main.length; i++) {
        //   console.log('hey', this.activeFilters().main[i]);
        //   this.removeFilterRow(i);
        // }
    }
    ...
    filtersChangedEmit() {
        console.log('emit', this.filterForm.value);
        this.activeFilters.update((current) => ({
            ...current,
    ...
    static ɵfac = i0.ɵɵngDeclareFactory({ minVersion: "12.0.0", version: "19.2.14", ngImport: i0, type: CustomFilterDropdownComponent, deps: [{ token: i1$2.FormBuilder }], target: i0.ɵɵFactoryTarget.Component });
    static ɵcmp = i0.ɵɵngDeclareComponent({ minVersion: "17.0.0", version: "19.2.14", type: CustomFilterDropdownComponent, isStandalone: true, selector: "custom-filter-dropdown", inputs: { filtersConfig: { classPropertyName: "filtersConfig", publicName: "filtersConfig", isSignal: false, isRequired: true, transformFunction: null }, activeFilters: { classPropertyName: "activeFilters", publicName: "activeFilters", isSignal: true, isRequired: false, transformFunction: null } }, outputs: { filtersChanged: "filtersChanged", activeFilters: "activeFiltersChange" }, ngImport: i0, template: "<form [formGroup]=\"filterForm\" class=\"form-container\">\r\n  <div class=\"filter-header\">\r\n    <p>\r\n      {{ \"FILTER.FILTER\" | translate }}\r\n    </p>\r\n    <button class=\"clear-button\" (click)=\"clearAll()\">\r\n      {{ \"FILTER.CLEAR_ALL\" | translate }}\r\n    </button>\r\n  </div>\r\n  @for(filterRow of activeFilters().main;track filterRow; let idx = $index) {\r\n  <div class=\"filter-row\">\r\n    <!-- Custom Dropdown for selecting filter type -->\r\n    <custom-dropdown\r\n      [options]=\"getAvailableOptions(idx)\"\r\n      [value]=\"filterRow.filterId\"\r\n      (valueChange)=\"onFilterDropdownChange($event, idx)\"\r\n      [placeholder]=\"'FILTER.SELECT_PLACE' | translate\"\r\n      [name]=\"'SelectType'\"\r\n      height=\"2.25em\"\r\n    ></custom-dropdown>\r\n\r\n    <!-- Render input if a filter is chosen -->\r\n    @if( filterRow.filterConfig) {\r\n    <ng-container>\r\n      @switch (filterRow.filterConfig.type) { @case('text'){\r\n      <custom-input-form\r\n        [parentForm]=\"filterForm\"\r\n        [placeholder]=\"filterRow.filterConfig.placeholder || ''\"\r\n        [controlName]=\"filterRow.filterConfig.nameEn\"\r\n        [type]=\"'text'\"\r\n        [validation]=\"filterRow.filterConfig.validation\"\r\n        [name]=\"filterRow.filterConfig.nameEn\"\r\n        class=\"bg-white\"\r\n        height=\"2.25em\"\r\n      ></custom-input-form>\r\n\r\n      } @case('multiselect'){\r\n      <custom-multi-select-form\r\n        *ngIf=\"filterRow.filterConfig.type === 'multiselect'\"\r\n        [parentForm]=\"filterForm\"\r\n        [controlName]=\"filterRow.filterConfig.nameEn\"\r\n        [options]=\"filterRow.filterConfig.options || emptyOptions\"\r\n        [validation]=\"filterRow.filterConfig.validation\"\r\n        [name]=\"filterRow.filterConfig.nameEn\"\r\n        (valueChange)=\"onDropdownChange($event, filterRow.filterConfig.nameEn)\"\r\n        [reset]=\"filterRow.filterConfig.reset\"\r\n        height=\"2.25em\"\r\n        [enableFilter]=\"true\"\r\n        [filterDesign]=\"true\"\r\n      ></custom-multi-select-form>\r\n      } @case('date'){\r\n      <custom-calender-form\r\n        *ngIf=\"filterRow.filterConfig.type === 'date'\"\r\n        [parentForm]=\"filterForm\"\r\n        [controlName]=\"filterRow.filterConfig.nameEn\"\r\n        [validation]=\"filterRow.filterConfig.validation\"\r\n        [name]=\"filterRow.filterConfig.nameEn\"\r\n        (valueChange)=\"onDateChange($event, filterRow.filterConfig.nameEn)\"\r\n        [disabled]=\"filterRow.filterConfig.disabled || false\"\r\n        height=\"2.25em\"\r\n      ></custom-calender-form>\r\n      } }\r\n    </ng-container>\r\n    }\r\n\r\n    <button\r\n      *ngIf=\"filterRow.filterConfig\"\r\n      class=\"clear-button\"\r\n      type=\"button\"\r\n      (click)=\"$event.stopPropagation(); removeFilterRow(idx)\"\r\n    >\r\n      <svg\r\n        width=\"20\"\r\n        height=\"20\"\r\n        viewBox=\"0 0 20 20\"\r\n        fill=\"none\"\r\n        xmlns=\"http://www.w3.org/2000/svg\"\r\n      >\r\n        <g clip-path=\"url(#clip0_9185_13729)\">\r\n          <path\r\n            d=\"M10.0001 19.0909C15.0209 19.0909 19.091 15.0208 19.091 10C19.091 4.97923 15.0209 0.909088 10.0001 0.909088C4.97932 0.909088 0.90918 4.97923 0.90918 10C0.90918 15.0208 4.97932 19.0909 10.0001 19.0909Z\"\r\n            stroke=\"#F35746\"\r\n            stroke-linecap=\"round\"\r\n            stroke-linejoin=\"round\"\r\n          />\r\n          <path\r\n            d=\"M12.7275 7.27274L7.27295 12.7273\"\r\n            stroke=\"#F35746\"\r\n            stroke-linecap=\"round\"\r\n            stroke-linejoin=\"round\"\r\n          />\r\n          <path\r\n            d=\"M7.27295 7.27274L12.7275 12.7273\"\r\n            stroke=\"#F35746\"\r\n            stroke-linecap=\"round\"\r\n            stroke-linejoin=\"round\"\r\n          />\r\n        </g>\r\n        <defs>\r\n          <clipPath id=\"clip0_9185_13729\">\r\n            <rect width=\"20\" height=\"20\" fill=\"white\" />\r\n          </clipPath>\r\n        </defs>\r\n      </svg>\r\n    </button>\r\n  </div>\r\n  }\r\n\r\n  <!-- Add button, disabled if all filters added -->\r\n  <div class=\"buttons-container\">\r\n    <button\r\n      type=\"submit\"\r\n      (click)=\"$event.stopPropagation(); addFilterRow()\"\r\n      [class]=\"'buttons'\"\r\n      [disabled]=\"(activeFilters().main?.length || 0) >= filterOptions.length\"\r\n    >\r\n      <svg\r\n        width=\"16\"\r\n        height=\"16\"\r\n        viewBox=\"0 0 23 23\"\r\n        fill=\"none\"\r\n        xmlns=\"http://www.w3.org/2000/svg\"\r\n      >\r\n        <g opacity=\"0.8\">\r\n          <path\r\n            d=\"M16.6169 16.617C19.5459 13.6881 19.5459 8.93935 16.6169 6.01042C13.688 3.08149 8.93926 3.08149 6.01033 6.01042C3.0814 8.93935 3.0814 13.6881 6.01033 16.617C8.93926 19.546 13.688 19.546 16.6169 16.617Z\"\r\n            stroke=\"#06213D\"\r\n            stroke-linecap=\"round\"\r\n            stroke-linejoin=\"round\"\r\n          />\r\n          <path\r\n            d=\"M11.3138 8.13174V14.4957\"\r\n            stroke=\"#06213D\"\r\n            stroke-linecap=\"round\"\r\n            stroke-linejoin=\"round\"\r\n          />\r\n          <path\r\n            d=\"M8.13184 11.3137H14.4958\"\r\n            stroke=\"#06213D\"\r\n            stroke-linecap=\"round\"\r\n            stroke-linejoin=\"round\"\r\n          />\r\n        </g>\r\n      </svg>\r\n\r\n      {{ \"FILTER.ADD\" | translate }}\r\n    </button>\r\n    <!-- <button\r\n      type=\"submit\"\r\n      (buttonClick)=\"filtersChangedEmit()\"\r\n      (click)=\"$event.stopPropagation()\"\r\n      [class]=\"'buttons'\"\r\n    >\r\n      {{ \"FILTER.SEARCH\" | translate }}\r\n    </button> -->\r\n  </div>\r\n</form>\r\n", styles: [".form-container{padding:1em;width:37em;height:100%;min-height:4em;font-size:1.6rem}.filter-header{display:flex;flex-direction:row;justify-content:space-between;align-items:center}.filter-row{display:grid;grid-template-columns:10fr 10fr 2fr;height:2.77em;gap:1em;margin-block:.25em;text-align:start;font-size:.8125em}.buttons{background:#f2f2f280;font-size:.8125em;color:#06213d;border-radius:.3125em;display:flex;justify-content:center;align-items:center;gap:.3em;padding:.35em .5em;cursor:pointer}.buttons:hover{box-shadow:inset 0 0 0 1000px #fff5}.buttons:disabled{box-shadow:inset 0 0 #fff5;cursor:not-allowed;opacity:.5}.buttons-container{display:flex;justify-content:space-between;align-items:center;padding:.4em 0}.clear-button{font-size:.75em;color:#06213d;border-radius:.3125em;display:flex;justify-content:center;align-items:center;gap:.5em;padding:.1em .2em;cursor:pointer}.clear-button:hover{box-shadow:inset 0 0 0 1000px #fff5}.clear-button:disabled{box-shadow:inset 0 0 #fff5;cursor:not-allowed;opacity:.5}.clear-button-container{display:flex;justify-content:space-between;align-items:center}\n"], dependencies: [{ kind: "ngmodule", type: CommonModule }, { kind: "directive", type: i2.NgIf, selector: "[ngIf]", inputs: ["ngIf", "ngIfThen", "ngIfElse"] }, { kind: "component", type: CustomInputFormComponent, selector: "custom-input-form", inputs: ["class", "labelClass", "label", "placeholder", "name", "type", "controlName", "parentForm", "validation", "pattern", "height"], outputs: ["valueChange"] }, { kind: "component", type: CustomCalenderFormComponent, selector: "custom-calender-form", inputs: ["label", "placeholder", "labelClass", "calendarPopUpClass", "calendarInputClass", "calendarContainerClass", "componentClass", "minDate", "maxDate", "controlName", "parentForm", "validation", "name", "disabled", "height"], outputs: ["valueChange"] }, { kind: "component", type: CustomMultiSelectFormComponent, selector: "custom-multi-select-form", inputs: ["parentForm", "controlName", "label", "labelClass", "dropdownOptionsClass", "dropdownHeaderClass", "dropdownContainerClass", "placeholder", "enableFilter", "filterDesign", "showClear", "options", "name", "validation", "height", "reset"] }, { kind: "ngmodule", type: ReactiveFormsModule }, { kind: "directive", type: i1$2.ɵNgNoValidate, selector: "form:not([ngNoForm]):not([ngNativeValidate])" }, { kind: "directive", type: i1$2.NgControlStatusGroup, selector: "[formGroupName],[formArrayName],[ngModelGroup],[formGroup],form:not([ngNoForm]),[ngForm]" }, { kind: "directive", type: i1$2.FormGroupDirective, selector: "[formGroup]", inputs: ["formGroup"], outputs: ["ngSubmit"], exportAs: ["ngForm"] }, { kind: "component", type: CustomDropdownComponent, selector: "custom-dropdown", inputs: ["label", "labelClass", "dropdownOptionsClass", "dropdownHeaderClass", "dropdownContainerClass", "placeholder", "enableFilter", "showClear", "options", "name", "value", "height", "reset"], outputs: ["valueChange"] }, { kind: "ngmodule", type: TranslateModule }, { kind: "pipe", type: i1$1.TranslatePipe, name: "translate" }] });
}
i0.ɵɵngDeclareClassMetadata({ minVersion: "12.0.0", version: "19.2.14", ngImport: i0, type: CustomFilterDropdownComponent, decorators: [{
            type: Component,
        ...
        }], ctorParameters: () => [{ type: i1$2.FormBuilder }], propDecorators: { filtersConfig: [{
                type: Input,
                args: [{ required: true }]
            }], filtersChanged: [{
                type: Output
...
class CustomFilterDynamicFormComponent {
    ...
    constructor(fb) {
        ...
        // effect(() => {
        //   if (this.config()) {
        //     this.filterForm = this.buildForm(this.config());
        //   }
        // });
    }
    ngOnInit() {
    ...
    buildForm(config) {
        ...
        for (const field of config) {
            ...
            group.addControl(field.id, this.fb.control(null, validators));
        }
        return group;
    }
    ...
    static ɵfac = i0.ɵɵngDeclareFactory({ minVersion: "12.0.0", version: "19.2.14", ngImport: i0, type: CustomFilterDynamicFormComponent, deps: [{ token: i1$2.FormBuilder }], target: i0.ɵɵFactoryTarget.Component });
    static ɵcmp = i0.ɵɵngDeclareComponent({ minVersion: "17.0.0", version: "19.2.14", type: CustomFilterDynamicFormComponent, isStandalone: true, selector: "custom-filter-dynamic-form", inputs: { config: { classPropertyName: "config", publicName: "config", isSignal: true, isRequired: false, transformFunction: null } }, outputs: { formChanged: "formChanged" }, ngImport: i0, template: "<div class=\"component-container\">\r\n  <div class=\"filter-header\">\r\n    <p class=\"title\">Filters</p>\r\n    <p (click)=\"reset()\" class=\"reset-btn\">Clear All</p>\r\n  </div>\r\n\r\n\r\n  <form [formGroup]=\"form\" class=\"filter-form\">\r\n    @for (field of config(); track $index) {\r\n     @switch (field.type) { @case\r\n    ('text') {\r\n    <div style=\"width: 100%\">\r\n      <custom-input-form\r\n        [parentForm]=\"form\"\r\n        [placeholder]=\"field.placeholder || ''\"\r\n        [controlName]=\"field.id\"\r\n        [type]=\"'text'\"\r\n        [validation]=\"[]\"\r\n        [name]=\"field.id\"\r\n        class=\"bg-white\"\r\n        height=\"2.25em\"\r\n      />\r\n    </div>\r\n    } @case ('date') {\r\n    <div style=\"width: 100%\">\r\n      <custom-calender-form\r\n        [parentForm]=\"form\"\r\n        [controlName]=\"field.id\"\r\n        [placeholder]=\"field.label\"\r\n        [validation]=\"[]\"\r\n        [name]=\"field.id\"\r\n        [disabled]=\"false\"\r\n        height=\"2.25em\"\r\n        [maxDate]=\"field.validation?.maxDate || null\"\r\n        [minDate]=\"field.validation?.minDate || null\"\r\n\r\n      />\r\n    </div>\r\n    } @case ('multiselect') {\r\n    <div style=\"width: 100% ;\">\r\n      <custom-multi-select-form\r\n        [parentForm]=\"form\"\r\n        [controlName]=\"field.id\"\r\n         [placeholder]=\"field.label\"\r\n        [options]=\"field.options || []\"\r\n        [validation]=\"[]\"\r\n        [name]=\"field.id\"\r\n        [reset]=\"false\"\r\n        height=\"2.25em\"\r\n        [enableFilter]=\"true\"\r\n        [filterDesign]=\"true\"\r\n        [dropdownOptionsClass]=\"'muli-select-wrapper'\"\r\n      />\r\n    </div>\r\n    } } }\r\n  </form>\r\n\r\n</div>\r\n", styles: [".component-container{padding:1em}.filter-header{display:flex;justify-content:space-between;align-items:center;padding:.5em 0;font-size:1em}.title{color:#06213d}.reset-btn{color:#f35746;cursor:pointer}.filter-form{display:flex;flex-direction:column;gap:.8em;align-items:start}::ng-deep .muli-select-wrapper{font-size:.8em}\n"], dependencies: [{ kind: "ngmodule", type: ReactiveFormsModule }, { kind: "directive", type: i1$2.ɵNgNoValidate, selector: "form:not([ngNoForm]):not([ngNativeValidate])" }, { kind: "directive", type: i1$2.NgControlStatusGroup, selector: "[formGroupName],[formArrayName],[ngModelGroup],[formGroup],form:not([ngNoForm]),[ngForm]" }, { kind: "directive", type: i1$2.FormGroupDirective, selector: "[formGroup]", inputs: ["formGroup"], outputs: ["ngSubmit"], exportAs: ["ngForm"] }, { kind: "component", type: CustomInputFormComponent, selector: "custom-input-form", inputs: ["class", "labelClass", "label", "placeholder", "name", "type", "controlName", "parentForm", "validation", "pattern", "height"], outputs: ["valueChange"] }, { kind: "component", type: CustomCalenderFormComponent, selector: "custom-calender-form", inputs: ["label", "placeholder", "labelClass", "calendarPopUpClass", "calendarInputClass", "calendarContainerClass", "componentClass", "minDate", "maxDate", "controlName", "parentForm", "validation", "name", "disabled", "height"], outputs: ["valueChange"] }, { kind: "component", type: CustomMultiSelectFormComponent, selector: "custom-multi-select-form", inputs: ["parentForm", "controlName", "label", "labelClass", "dropdownOptionsClass", "dropdownHeaderClass", "dropdownContainerClass", "placeholder", "enableFilter", "filterDesign", "showClear", "options", "name", "validation", "height", "reset"] }] });
}
i0.ɵɵngDeclareClassMetadata({ minVersion: "12.0.0", version: "19.2.14", ngImport: i0, type: CustomFilterDynamicFormComponent, decorators: [{
            type: Component,
        ...
        }], ctorParameters: () => [{ type: i1$2.FormBuilder }], propDecorators: { formChanged: [{
                type: Output
            }] } });
