...
import { retry, catchError, BehaviorSubject, Observable, map, throwError, finalize, tap, Subscription, fromEvent, filter, Subject, debounceTime, distinctUntilChanged } from 'rxjs';
...
class CustomFilterDynamicFormComponent {
    ...
    ngOnInit() {
        this.filters.set(this.config);
        this.filterForm = this.buildForm(this.filters());
        this.filterForm.valueChanges.subscribe((val) => {
    ...
    getMinDate(field) {
        return field.validation?.minDate?.toISOString().split('T')[0] ?? null;
    }
    getMaxDate(field) {
        return field.validation?.maxDate?.toISOString().split('T')[0] ?? null;
    }
    get form() {
...
i0.ɵɵngDeclareClassMetadata({ minVersion: "12.0.0", version: "19.2.14", ngImport: i0, type: CustomFilterDynamicFormComponent, decorators: [{
            type: Component,
            args: [{ selector: 'custom-filter-dynamic-form', imports: [ReactiveFormsModule, CustomInputFormComponent, CustomCalenderFormComponent, CustomMultiSelectFormComponent], template: "<form [formGroup]=\"form\" class=\"filter-form\">\r\n  @for (field of filters(); track field.id) {\r\n    <div class=\"form-row\">\r\n      <label [for]=\"field.id\">{{ field.label }}</label>\r\n\r\n      @if (field.type === 'text') {\r\n        <custom-input-form\r\n          [parentForm]=\"filterForm\"\r\n          [placeholder]=\"field.placeholder || ''\"\r\n          [controlName]=\"field.id\"\r\n          [type]=\"'text'\"\r\n          [validation]=\"[]\"\r\n          [name]=\"field.id\"\r\n          class=\"bg-white\"\r\n          height=\"2.25em\"\r\n        />\r\n      }\r\n\r\n      @if (field.type === 'date') {\r\n        <custom-calender-form\r\n          [parentForm]=\"filterForm\"\r\n          [controlName]=\"field.id\"\r\n          [validation]=\"[]\"\r\n          [name]=\"field.id\"\r\n          [disabled]=\"false\"\r\n          height=\"2.25em\"\r\n        />\r\n      }\r\n\r\n      @if (field.type === 'multiselect') {\r\n        <custom-multi-select-form\r\n          [parentForm]=\"filterForm\"\r\n          [controlName]=\"field.id\"\r\n          [options]=\"field.options || []\"\r\n          [validation]=\"[]\"\r\n          [name]=\"field.id\"\r\n          [reset]=\"false\"\r\n          height=\"2.25em\"\r\n          [enableFilter]=\"true\"\r\n          [filterDesign]=\"true\"\r\n        />\r\n      }\r\n    </div>\r\n  }\r\n</form>\r\n", styles: [".filter-form{display:flex;flex-direction:column;gap:1rem}.form-row{display:flex;flex-direction:column}\n"] }]
