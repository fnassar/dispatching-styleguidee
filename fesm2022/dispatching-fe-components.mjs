...
import { Injectable, signal, InjectionToken, Inject, computed, Optional, inject, input, Input, Component, EventEmitter, Output, HostListener, Directive, PLATFORM_ID, effect, HostBinding, ContentChild, ViewChild, ViewEncapsulation, model } from '@angular/core';
...
class DropdownsAnimationDirective {
    ...
    static ɵfac = i0.ɵɵngDeclareFactory({ minVersion: "12.0.0", version: "19.2.14", ngImport: i0, type: DropdownsAnimationDirective, deps: [], target: i0.ɵɵFactoryTarget.Directive });
    static ɵdir = i0.ɵɵngDeclareDirective({ minVersion: "14.0.0", version: "19.2.14", type: DropdownsAnimationDirective, isStandalone: true, selector: "[DropdownAnimationObject]", inputs: { isOpen: ["DropdownAnimationObject", "isOpen"] }, host: { properties: { "@dropdown": "this.dropdown" } }, ngImport: i0 });
}
i0.ɵɵngDeclareClassMetadata({ minVersion: "12.0.0", version: "19.2.14", ngImport: i0, type: DropdownsAnimationDirective, decorators: [{
            type: Directive,
            args: [{
...
i0.ɵɵngDeclareClassMetadata({ minVersion: "12.0.0", version: "19.2.14", ngImport: i0, type: CustomCalenderFormComponent, decorators: [{
            ...
            args: [{ selector: 'custom-calender-form', standalone: true, imports: [
                        ...
                        CommonModule,
                        DropdownsAnimationDirective,
                    ], animations: [dropdownAnimation], template: "<div [class]=\"'fullWidth ' + componentClass\" [formGroup]=\"parentForm\">\n  @if(label){\n  <label [for]=\"label\" [class]=\"'custom-label ' + labelClass\">\n    {{ label }}\n    @if(containRequiredError()){\n    <span style=\"color: #f43f5e; font-size: 15px; font-weight: 500\">*</span>\n    } @else{\n    <span style=\"color: #f43f5e; font-size: 15px; font-weight: 500\"\n      >&nbsp;</span\n    >\n    }\n  </label>\n  }\n\n  <div [class]=\"'custom-calendar-container ' + calendarContainerClass\">\n    <div class=\"calendar-error-container\">\n      <custom-app-error\n        [control]=\"parentForm.controls[controlName]\"\n        [validation]=\"validation\"\n        [name]=\"name\"\n      />\n    </div>\n\n    <div\n      [class]=\"'custom-calendar-input ' + calendarInputClass\"\n      [class.disabled]=\"disabled\"\n      [attr.aria-disabled]=\"disabled\"\n      (click)=\"!disabled && toggleCalendar()\"\n      [class.has-error]=\"\n        parentForm.controls[controlName].invalid &&\n        parentForm.controls[controlName].touched\n      \"\n      [ngStyle]=\"{ '--height': height }\"\n    >\n      <span class=\"placeholder\" *ngIf=\"!value\">{{ placeholder }}</span>\n      <span *ngIf=\"value\">{{ formatDisplayDate() }}</span>\n      <span class=\"calendar-icon\">\n        <svg\n          width=\"inherit\"\n          height=\"inherit\"\n          viewBox=\"0 0 24 24\"\n          fill=\"none\"\n          xmlns=\"http://www.w3.org/2000/svg\"\n        >\n          <path\n            d=\"M8 2V5\"\n            stroke=\"#999999\"\n            stroke-width=\"1.5\"\n            stroke-miterlimit=\"10\"\n            stroke-linecap=\"round\"\n            stroke-linejoin=\"round\"\n          />\n          <path\n            d=\"M16 2V5\"\n            stroke=\"#999999\"\n            stroke-width=\"1.5\"\n            stroke-miterlimit=\"10\"\n            stroke-linecap=\"round\"\n            stroke-linejoin=\"round\"\n          />\n          <path\n            d=\"M3.5 9.08984H20.5\"\n            stroke=\"#999999\"\n            stroke-width=\"1.5\"\n            stroke-miterlimit=\"10\"\n            stroke-linecap=\"round\"\n            stroke-linejoin=\"round\"\n          />\n          <path\n            d=\"M21 8.5V17C21 20 19.5 22 16 22H8C4.5 22 3 20 3 17V8.5C3 5.5 4.5 3.5 8 3.5H16C19.5 3.5 21 5.5 21 8.5Z\"\n            stroke=\"#999999\"\n            stroke-width=\"1.5\"\n            stroke-miterlimit=\"10\"\n            stroke-linecap=\"round\"\n            stroke-linejoin=\"round\"\n          />\n          <path\n            d=\"M15.6947 13.7002H15.7037\"\n            stroke=\"#999999\"\n            stroke-width=\"2\"\n            stroke-linecap=\"round\"\n            stroke-linejoin=\"round\"\n          />\n          <path\n            d=\"M15.6947 16.7002H15.7037\"\n            stroke=\"#999999\"\n            stroke-width=\"2\"\n            stroke-linecap=\"round\"\n            stroke-linejoin=\"round\"\n          />\n          <path\n            d=\"M11.9955 13.7002H12.0045\"\n            stroke=\"#999999\"\n            stroke-width=\"2\"\n            stroke-linecap=\"round\"\n            stroke-linejoin=\"round\"\n          />\n          <path\n            d=\"M11.9955 16.7002H12.0045\"\n            stroke=\"#999999\"\n            stroke-width=\"2\"\n            stroke-linecap=\"round\"\n            stroke-linejoin=\"round\"\n          />\n          <path\n            d=\"M8.29431 13.7002H8.30329\"\n            stroke=\"#999999\"\n            stroke-width=\"2\"\n            stroke-linecap=\"round\"\n            stroke-linejoin=\"round\"\n          />\n          <path\n            d=\"M8.29431 16.7002H8.30329\"\n            stroke=\"#999999\"\n            stroke-width=\"2\"\n            stroke-linecap=\"round\"\n            stroke-linejoin=\"round\"\n          />\n        </svg>\n      </span>\n    </div>\n\n    @if(showCalendarForm && !disabled) {\n    <div\n      [class]=\"'calendar-popup ' + calendarPopUpClass\"\n      #calendarPopUpForm\n      [clickOutside]=\"calendarPopUpForm\"\n      (clickOutsideEmitter)=\"closeCalendar()\"\n      [DropdownAnimationObject]=\"showCalendarForm\"\n    >\n      <div class=\"calendar-header\">\n        <button type=\"button\" class=\"nav-button\" (click)=\"prevMonth()\">\n          <svg\n            width=\"8\"\n            height=\"12\"\n            viewBox=\"0 0 8 12\"\n            fill=\"none\"\n            xmlns=\"http://www.w3.org/2000/svg\"\n          >\n            <path\n              d=\"M6.5 11L1.5 6L6.5 1\"\n              stroke=\"black\"\n              stroke-opacity=\"0.72\"\n              stroke-width=\"1.66667\"\n              stroke-linecap=\"round\"\n              stroke-linejoin=\"round\"\n            />\n          </svg>\n        </button>\n        <div class=\"month-title\">{{ getMonthName() }} {{ getYear() }}</div>\n        <button type=\"button\" class=\"nav-button\" (click)=\"nextMonth()\">\n          <svg\n            width=\"8\"\n            height=\"12\"\n            viewBox=\"0 0 8 12\"\n            fill=\"none\"\n            xmlns=\"http://www.w3.org/2000/svg\"\n          >\n            <path\n              d=\"M1.5 11L6.5 6L1.5 1\"\n              stroke=\"black\"\n              stroke-opacity=\"0.72\"\n              stroke-width=\"1.66667\"\n              stroke-linecap=\"round\"\n              stroke-linejoin=\"round\"\n            />\n          </svg>\n        </button>\n      </div>\n\n      <div class=\"weekdays\">\n        @for(weekday of weekdays; track weekday) {\n        <div class=\"weekday\">{{ weekday }}</div>\n        }\n      </div>\n\n      <div class=\"days-grid\">\n        @for(day of days; track day) {\n        <div\n          class=\"day\"\n          [class.current-month]=\"isCurrentMonth(day)\"\n          [class.selected]=\"isSelected(day)\"\n          [class.disabled]=\"isDisabled(day) || disabled\"\n          (click)=\"\n            $event.stopPropagation();\n            !isDisabled(day) && !disabled && selectDate(day)\n          \"\n        >\n          {{ day.getDate() }}\n        </div>\n        }\n      </div>\n    </div>\n    }\n  </div>\n</div>\n", styles: [".custom-calendar-container{position:relative;width:100%}.fullWidth{width:100%}.custom-label{display:block;font-size:1em;font-weight:500;color:#707070;margin-bottom:.3em}.custom-calendar-input{position:relative;height:var(--height);width:100%;border:1px solid #82828233;border-radius:6px;padding:0 12px;display:flex;align-items:center;cursor:pointer;background-color:#fff}.custom-calendar-input.has-error{border:1px solid #e55658;box-shadow:1px 0 6px #e5565826}.placeholder{color:#82828250;font-size:.95em}.calendar-icon{position:absolute;right:12px;height:calc(var(--height) / 2.4)}.calendar-popup{position:absolute;top:100%;left:0;right:0;max-height:300px;overflow-y:auto;background-color:#fff;border:1px solid #82828233;border-radius:.375em;margin-top:4px;padding:1rem;z-index:10;box-shadow:0 4px 6px #0000001a}.calendar-header{display:flex;justify-content:space-between;align-items:center;margin-bottom:12px}.month-title{font-weight:600}.nav-button{background:none;border:none;font-size:16px;cursor:pointer;padding:4px 8px}.weekdays{display:grid;grid-template-columns:repeat(7,1fr);text-align:center;font-weight:500;font-size:12px;margin-bottom:8px}.days-grid{display:grid;grid-template-columns:repeat(7,1fr);gap:4px}.day{height:32px;display:flex;align-items:center;justify-content:center;border-radius:4px;cursor:pointer;font-size:14px}.day.current-month{color:#111827}.day:not(.current-month){color:#9ca3af}.day.selected{background-color:#602650;color:#fff}.day.disabled{color:#d1d5db;cursor:not-allowed;text-decoration:line-through}.day:not(.disabled):not(.selected):hover{background-color:#f3f4f6}.custom-calendar-input.disabled{background:#f3f3f3;color:#b0b0b0;cursor:not-allowed;border-color:#e0e0e0}.calendar-error-container{position:absolute;top:100%;left:.73em;width:100%}.calendar-error-container custom-app-error{pointer-events:none}\n"] }]
        }], ctorParameters: () => [], propDecorators: { label: [{
                type: Input
            }], placeholder: [{
                type: Input
...
i0.ɵɵngDeclareClassMetadata({ minVersion: "12.0.0", version: "19.2.14", ngImport: i0, type: CustomDropdownFormComponent, decorators: [{
            ...
            args: [{ selector: 'custom-dropdown-form', standalone: true, imports: [
                        ...
                        CustomAppErrorComponent,
                        DropdownsAnimationDirective,
                    ], animations: [dropdownAnimation], template: "<div style=\"width: 100%\" [formGroup]=\"parentForm\">\n  @if(label){\n  <label [for]=\"label\" [class]=\"'custom-label ' + labelClass\">\n    {{ label }}\n    @if(containRequiredError()){\n    <span style=\"color: #f43f5e; font-size: 15px; font-weight: 500\">*</span>\n    } @else{\n    <span style=\"color: #f43f5e; font-size: 15px; font-weight: 500\"\n      >&nbsp;</span\n    >\n    }\n  </label>\n  }\n\n  <div\n    [class]=\"'dropdown-container ' + dropdownContainerClass\"\n    [class.disabled]=\"disabled\"\n  >\n    <div class=\"dropdown-error-container\">\n      <custom-app-error\n        [control]=\"parentForm.controls[controlName]\"\n        [validation]=\"validation\"\n        [name]=\"name\"\n      />\n    </div>\n    <div\n      [class]=\"'dropdown-header ' + dropdownHeaderClass\"\n      [class.disabled]=\"disabled\"\n      (click)=\"!disabled && toggleDropdown()\"\n      [style.cursor]=\"disabled ? 'not-allowed' : 'pointer'\"\n      [class.has-error]=\"\n        parentForm.controls[controlName].invalid &&\n        parentForm.controls[controlName].touched &&\n        validation.length > 0\n      \"\n      [ngStyle]=\"{ '--height': height }\"\n    >\n      @if (selectedOption && selectedOption.nameEn){\n      <span class=\"selected-value\"> {{ selectedOption.nameEn }} </span>} @else {\n      <span class=\"selected-value placeholder\">\n        {{ placeholder }}\n      </span>\n      }\n      <div class=\"dropdown-icons\">\n        @if(selectedOption && showClear && !disabled){\n        <span class=\"clear-icon\" (click)=\"clearSelection($event)\">\n          <svg\n            width=\"inherit\"\n            height=\"inherit\"\n            viewBox=\"0 0 17 17\"\n            fill=\"none\"\n            xmlns=\"http://www.w3.org/2000/svg\"\n          >\n            <g clip-path=\"url(#clip0_30_1710)\">\n              <path\n                d=\"M15.0539 1.8631L1.69678 15.2202\"\n                stroke=\"#999999\"\n                stroke-width=\"2\"\n                stroke-linecap=\"round\"\n                stroke-linejoin=\"round\"\n              />\n              <path\n                d=\"M1.69678 1.8631L15.0539 15.2202\"\n                stroke=\"#999999\"\n                stroke-width=\"2\"\n                stroke-linecap=\"round\"\n                stroke-linejoin=\"round\"\n              />\n            </g>\n            <defs>\n              <clipPath id=\"clip0_30_1710\">\n                <rect\n                  width=\"15.5833\"\n                  height=\"15.5833\"\n                  fill=\"white\"\n                  transform=\"translate(0.583496 0.75)\"\n                />\n              </clipPath>\n            </defs>\n          </svg>\n        </span>\n        }\n        <svg\n          style=\"min-height: 12px\"\n          width=\"inherit\"\n          height=\"inherit\"\n          viewBox=\"0 0 17 16\"\n          fill=\"none\"\n          xmlns=\"http://www.w3.org/2000/svg\"\n        >\n          <path\n            d=\"M14.5 5.5L9.56061 11.0118C8.97727 11.6627 8.02273 11.6627 7.43939 11.0118L2.5 5.5\"\n            stroke=\"#999999\"\n            stroke-miterlimit=\"10\"\n            stroke-linecap=\"round\"\n            stroke-linejoin=\"round\"\n          />\n        </svg>\n      </div>\n    </div>\n    @if(isOpen && !disabled){\n    <div\n      #dropdownOptions\n      [class]=\"'dropdown-options ' + dropdownOptionsClass\"\n      [clickOutside]=\"dropdownOptions\"\n      (clickOutsideEmitter)=\"closeDropdown()\"\n      [DropdownAnimationObject]=\"isOpen\"\n    >\n      @if(enableFilter){\n      <div class=\"filter-container\">\n        <input\n          type=\"text\"\n          class=\"filter-input\"\n          placeholder=\"Filter options...\"\n          #filterInput\n          (input)=\"filterText = filterInput.value; filterOptions()\"\n          [disabled]=\"disabled\"\n        />\n      </div>\n      }\n      <div class=\"options-list\">\n        @for(option of filteredOptions; track option.id){\n        <div\n          class=\"dropdown-option\"\n          [class.selected]=\"option.id === selectedOption?.id\"\n          (click)=\"$event.stopPropagation(); selectOption(option)\"\n        >\n          {{ option.nameEn }}\n        </div>\n        } @if(filteredOptions.length === 0){\n        <div class=\"no-options\">No options found</div>\n        }\n      </div>\n    </div>\n    }\n  </div>\n\n  <input\n    type=\"hidden\"\n    [id]=\"label\"\n    [name]=\"name\"\n    [formControlName]=\"controlName\"\n    [disabled]=\"disabled\"\n  />\n</div>\n", styles: [".dropdown-container{position:relative;width:100%}.dropdown-header{height:var(--height);width:100%;border-radius:.375em;border:1px solid #82828233;padding:0 1em;display:flex;align-items:center;justify-content:space-between;cursor:pointer;background-color:#fff}.dropdown-header.has-error{border:1px solid #e55658;box-shadow:1px 0 6px #e5565826}.selected-value{flex:1;overflow:hidden;text-overflow:ellipsis;white-space:nowrap;color:#374151;font-size:.95em}.selected-value.placeholder{color:#82828250}.dropdown-icons{display:flex;align-items:center;gap:8px;height:calc(var(--height) / 3)}.clear-icon{color:#9ca3af;font-size:1.2rem;cursor:pointer;height:calc(var(--height) / 2)}.clear-icon:hover{color:#6b7280}.dropdown-options{position:absolute;top:100%;left:0;right:0;max-height:16em;overflow-y:auto;background-color:#fff;border:1px solid #82828233;border-radius:.375em;margin-top:4px;z-index:10;box-shadow:0 4px 6px #0000001a}.filter-container{padding:80px;border-bottom:1px solid #e5e7eb;background-color:red}.filter-input{width:100%;padding:8px;border:1px solid #82828233;border-radius:.25rem;outline:none}.options-list{padding:4px 0}.dropdown-option{cursor:pointer;height:var(--height);width:100%;display:flex;justify-content:start;align-items:center;font-family:var(--FM-Light);padding:.3em .5em}.dropdown-option:hover{background-color:#f3f4f6}.dropdown-option.selected{background-color:#e5e7eb;font-weight:500}.no-options{padding:8px 16px;color:#9ca3af;font-style:italic}.custom-label{font-size:1em;font-weight:500;display:block;color:#707070;margin-bottom:.3em}.disabled{background-color:#f3f4f6}.dropdown-error-container{position:absolute;top:100%;left:.7em;width:100%}.dropdown-error-container custom-app-error{pointer-events:none}\n"] }]
...
i0.ɵɵngDeclareClassMetadata({ minVersion: "12.0.0", version: "19.2.14", ngImport: i0, type: CustomMultiSelectComponent, decorators: [{
            type: Component,
            args: [{ selector: 'custom-multi-select', standalone: true, imports: [
                        NgStyle,
                        FormsModule,
                        ClickOutsideDirective,
                        DropdownsAnimationDirective,
                    ], animations: [dropdownAnimation], template: "<div style=\"width: 100%\">\n  @if(label){\n  <label [for]=\"label\" [class]=\"'custom-label ' + labelClass\">\n    {{ label }}\n  </label>\n  }\n\n  <div [class]=\"'dropdown-container ' + dropdownContainerClass\">\n    <div\n      [class]=\"'dropdown-header ' + dropdownHeaderClass\"\n      (click)=\"toggleDropdown()\"\n      [ngStyle]=\"{ '--height': height }\"\n    >\n      <span class=\"selected-value\">\n        {{ selectedOptions.length > 0 ? getSelectedLabels() : placeholder }}\n      </span>\n      <div class=\"dropdown-icons\">\n        @if(selectedOptions.length > 0 && showClear){\n        <span class=\"clear-icon\" (click)=\"clearSelection($event)\">\n          <svg\n            width=\"inherit\"\n            height=\"inherit\"\n            viewBox=\"0 0 17 17\"\n            fill=\"none\"\n            xmlns=\"http://www.w3.org/2000/svg\"\n          >\n            <g clip-path=\"url(#clip0_30_1710)\">\n              <path\n                d=\"M15.0539 1.8631L1.69678 15.2202\"\n                stroke=\"#999999\"\n                stroke-width=\"2\"\n                stroke-linecap=\"round\"\n                stroke-linejoin=\"round\"\n              />\n              <path\n                d=\"M1.69678 1.8631L15.0539 15.2202\"\n                stroke=\"#999999\"\n                stroke-width=\"2\"\n                stroke-linecap=\"round\"\n                stroke-linejoin=\"round\"\n              />\n            </g>\n            <defs>\n              <clipPath id=\"clip0_30_1710\">\n                <rect\n                  width=\"15.5833\"\n                  height=\"15.5833\"\n                  fill=\"white\"\n                  transform=\"translate(0.583496 0.75)\"\n                />\n              </clipPath>\n            </defs>\n          </svg>\n        </span>\n        }\n        <svg\n          style=\"min-height: 12px\"\n          width=\"inherit\"\n          height=\"inherit\"\n          viewBox=\"0 0 17 16\"\n          fill=\"none\"\n          xmlns=\"http://www.w3.org/2000/svg\"\n        >\n          <path\n            d=\"M14.5 5.5L9.56061 11.0118C8.97727 11.6627 8.02273 11.6627 7.43939 11.0118L2.5 5.5\"\n            stroke=\"#999999\"\n            stroke-miterlimit=\"10\"\n            stroke-linecap=\"round\"\n            stroke-linejoin=\"round\"\n          />\n        </svg>\n      </div>\n    </div>\n\n    @if(isOpen){\n    <div\n      #dropdownOptions\n      [class]=\"'dropdown-options ' + dropdownOptionsClass\"\n      [clickOutside]=\"dropdownOptions\"\n      (clickOutsideEmitter)=\"isOpen = false\"\n      [DropdownAnimationObject]=\"isOpen\"\n    >\n      @if(enableFilter){\n      <div class=\"filter-container\">\n        <input\n          type=\"text\"\n          class=\"filter-input\"\n          placeholder=\"Filter options...\"\n          #filterInput\n          (input)=\"filterText = filterInput.value; filterOptions()\"\n        />\n      </div>\n      }\n\n      <div class=\"options-list\">\n        @for(option of filteredOptions; track option.id){\n        <div class=\"dropdown-option\" (click)=\"toggleOptionSelection(option)\">\n          <input\n            type=\"checkbox\"\n            class=\"custom-checkbox\"\n            [checked]=\"isSelected(option.id)\"\n            (click)=\"$event.stopPropagation()\"\n          />\n          <span>{{ option.nameEn }}</span>\n        </div>\n        } @if(filteredOptions.length === 0){\n        <div class=\"no-options\">No options found</div>\n        }\n      </div>\n    </div>\n    }\n  </div>\n</div>\n", styles: [".dropdown-container{position:relative;width:100%}.dropdown-header{height:var(--height);width:100%;border-radius:.375em;border:1px solid #82828233;padding:0 1em;display:flex;align-items:center;justify-content:space-between;cursor:pointer;background-color:#fff}.selected-value{flex:1;overflow:hidden;text-overflow:ellipsis;white-space:nowrap;color:#374151;font-size:.95em}.dropdown-icons{display:flex;align-items:center;gap:8px;height:calc(var(--height) / 3)}.clear-icon{color:#9ca3af;font-size:1.2rem;cursor:pointer;height:calc(var(--height) / 2)}.clear-icon:hover{color:#6b7280}.dropdown-options{position:absolute;top:100%;left:0;right:0;max-height:16em;overflow-y:auto;background-color:#fff;border:1px solid #82828233;border-radius:.375em;margin-top:4px;z-index:10;box-shadow:0 4px 6px #0000001a}.filter-container{padding:8px;border-bottom:1px solid #e5e7eb}.filter-input{width:100%;padding:8px;border:1px solid #82828233;border-radius:.25rem;outline:none}.options-list{padding:4px 0}.dropdown-option{padding:8px 16px;cursor:pointer}.dropdown-option.selected{background-color:#e5e7eb;font-weight:500}.no-options{padding:8px 16px;color:#9ca3af;font-style:italic}.custom-label{font-size:1em;font-weight:500;display:block;color:#707070;margin-bottom:.3em}.dropdown-option{display:flex;align-items:center;gap:12px;padding:10px 16px;cursor:pointer;transition:background-color .2s}.dropdown-option:hover{background-color:#f3f4f6}.option-label{flex:1}.custom-checkbox{appearance:none;width:20px;height:20px;border:2px solid #ccc;border-radius:3px;position:relative;outline:none;cursor:pointer;transition:border-color .3s ease,background-color .3s ease;flex-shrink:0}.custom-checkbox:checked{background-color:#25c7bc;border-color:#25c7bc}.custom-checkbox:checked:after{content:\"\";position:absolute;top:0;left:5px;width:6px;height:12px;border:solid white;border-width:0 2px 2px 0;transform:rotate(45deg)}.custom-checkbox:focus{border-color:#25c7bc}.dropdown-option.selected{background-color:#e5e7eb}.no-options{padding:12px 16px;color:#6b7280;font-style:italic;text-align:center}\n"] }]
        }], propDecorators: { label: [{
                type: Input
            }], labelClass: [{
                type: Input
...
class CustomPaginationComponent {
    ...
    onPageSizeChange(event) {
        ...
        console.log('PAGE EVENT', selectElement);
        this.pageChange.emit({
            page: this.page <= maxPageNum ? this.page : maxPageNum,
            pageSize: selectElement, // The + converts string to number
        });
    }
...
class CustomTableComponent {
    ...
    static ɵfac = i0.ɵɵngDeclareFactory({ minVersion: "12.0.0", version: "19.2.14", ngImport: i0, type: CustomTableComponent, deps: [{ token: i1$4.DomSanitizer }], target: i0.ɵɵFactoryTarget.Component });
...
i0.ɵɵngDeclareClassMetadata({ minVersion: "12.0.0", version: "19.2.14", ngImport: i0, type: OverlayPanelComponent, decorators: [{
            type: Component,
            args: [{ selector: 'overlay-panel', imports: [ClickOutsideDirective, CommonModule, DropdownsAnimationDirective], animations: [dropdownAnimation], template: "<div class=\"overlay-container\">\n  <!-- Target content -->\n  <div (click)=\"toggleDropdown($event)\">\n    <ng-container *ngIf=\"targetTemplate\">\n      <ng-container *ngTemplateOutlet=\"targetTemplate\"></ng-container>\n    </ng-container>\n  </div>\n\n  <!-- Overlay content -->\n  @if(isOpen) {\n  <div\n    #overlayPanel\n    class=\"overlay\"\n    [class]=\"'overlay ' + overlayClass\"\n    [class.show]=\"isOpen\"\n    [class.right]=\"expandSide === 'RIGHT'\"\n    [class.left]=\"expandSide === 'LEFT'\"\n    [clickOutside]=\"overlayPanel\"\n    (clickOutsideEmitter)=\"closeDropdown()\"\n    [DropdownAnimationObject]=\"isOpen\"\n  >\n    <ng-container *ngIf=\"overlayTemplate\">\n      <ng-container *ngTemplateOutlet=\"overlayTemplate\"></ng-container>\n    </ng-container>\n  </div>\n  }\n</div>\n", styles: [".overlay-container{position:relative;display:inline-block}.overlay{position:absolute;top:100%;min-width:15em;max-height:60vh;background-color:#fff;border-radius:.625em;margin-top:.4em;z-index:10000000;box-shadow:0 0 4px #0000001a;opacity:0;transform:translateY(-10px);pointer-events:none;transition:opacity .2s ease,transform .2s ease}.overlay.show{opacity:1;transform:translateY(0);pointer-events:auto;border-radius:.625em}.overlay.right{right:0;left:auto}.overlay.left{left:0;right:auto}\n"] }]
...
i0.ɵɵngDeclareClassMetadata({ minVersion: "12.0.0", version: "19.2.14", ngImport: i0, type: CustomFileUploadComponent, decorators: [{
        ...
        }], ctorParameters: () => [{ type: i1$4.DomSanitizer }], propDecorators: { parentForm: [{
                type: Input,
                args: [{ required: true }]
            }], FileTypes: [{
                type: Input,
...
class CustomFileViewerComponent {
    ...
    static ɵfac = i0.ɵɵngDeclareFactory({ minVersion: "12.0.0", version: "19.2.14", ngImport: i0, type: CustomFileViewerComponent, deps: [{ token: i1$4.DomSanitizer }], target: i0.ɵɵFactoryTarget.Component });
...
i0.ɵɵngDeclareClassMetadata({ minVersion: "12.0.0", version: "19.2.14", ngImport: i0, type: CustomFileViewerComponent, decorators: [{
        ...
        }], ctorParameters: () => [{ type: i1$4.DomSanitizer }], propDecorators: { file: [{
                type: Input,
                args: [{ required: true }]
            }], showMenu: [{
                type: Input
...
class CustomSteppersContainerComponent {
    ...
    static ɵfac = i0.ɵɵngDeclareFactory({ minVersion: "12.0.0", version: "19.2.14", ngImport: i0, type: CustomSteppersContainerComponent, deps: [{ token: StepperService }, { token: i1$4.DomSanitizer }], target: i0.ɵɵFactoryTarget.Component });
...
i0.ɵɵngDeclareClassMetadata({ minVersion: "12.0.0", version: "19.2.14", ngImport: i0, type: CustomSteppersContainerComponent, decorators: [{
        ...
        }], ctorParameters: () => [{ type: StepperService }, { type: i1$4.DomSanitizer }], propDecorators: { steps: [{
                type: Input
            }] } });
...
i0.ɵɵngDeclareClassMetadata({ minVersion: "12.0.0", version: "19.2.14", ngImport: i0, type: CustomFieldsFormComponent, decorators: [{
        ...
        }], ctorParameters: () => [{ type: i1$3.FormBuilder }], propDecorators: { parentForm: [{
                type: Input,
                args: [{ required: true }]
            }], controlName: [{
                type: Input,
...
class CustomDynamicTableWithCategoriesComponent {
    ...
    static ɵfac = i0.ɵɵngDeclareFactory({ minVersion: "12.0.0", version: "19.2.14", ngImport: i0, type: CustomDynamicTableWithCategoriesComponent, deps: [{ token: i1$4.DomSanitizer }], target: i0.ɵɵFactoryTarget.Component });
...
i0.ɵɵngDeclareClassMetadata({ minVersion: "12.0.0", version: "19.2.14", ngImport: i0, type: CustomDynamicTableWithCategoriesComponent, decorators: [{
            type: Component,
            args: [{ selector: 'custom-dynamic-table-with-categories', imports: [TranslateModule, NgClass, NgTemplateOutlet], animations: [
                        trigger('rowFade', [
                            transition(':enter', [
                                style({ opacity: 0 }),
                                animate('1s ease-in', style({ opacity: 1 })),
...
class CustomDropdownButtonComponent {
    ...
    static ɵfac = i0.ɵɵngDeclareFactory({ minVersion: "12.0.0", version: "19.2.14", ngImport: i0, type: CustomDropdownButtonComponent, deps: [{ token: i1$4.DomSanitizer }], target: i0.ɵɵFactoryTarget.Component });
...
i0.ɵɵngDeclareClassMetadata({ minVersion: "12.0.0", version: "19.2.14", ngImport: i0, type: CustomDropdownButtonComponent, decorators: [{
        ...
        }], ctorParameters: () => [{ type: i1$4.DomSanitizer }], propDecorators: { options: [{
                type: Input,
                args: [{ required: true }]
            }], selected: [{
                type: Output
...
class CustomDetailsHeaderComponent {
    ...
    static ɵfac = i0.ɵɵngDeclareFactory({ minVersion: "12.0.0", version: "19.2.14", ngImport: i0, type: CustomDetailsHeaderComponent, deps: [{ token: i1$4.DomSanitizer }], target: i0.ɵɵFactoryTarget.Component });
...
i0.ɵɵngDeclareClassMetadata({ minVersion: "12.0.0", version: "19.2.14", ngImport: i0, type: CustomDetailsHeaderComponent, decorators: [{
        ...
        }], ctorParameters: () => [{ type: i1$4.DomSanitizer }], propDecorators: { showX: [{
                type: Input
            }], BreadCrumbs: [{
                type: Input,
                args: [{ required: true }]
...
class CustomTabsComponent {
    ...
    static ɵcmp = i0.ɵɵngDeclareComponent({ minVersion: "17.0.0", version: "19.2.14", type: CustomTabsComponent, isStandalone: true, selector: "custom-tabs", inputs: { tabsList: "tabsList", color: "color", colorSelected: "colorSelected", tabTemplates: "tabTemplates", selectedTab: "selectedTab" }, outputs: { tabSelected: "tabSelected" }, ngImport: i0, template: "<!-- tab-selector.component.html -->\n<div class=\"tab-container\">\n  @for (tab of tabsList; track tab) {\n  <button\n    class=\"tab-button\"\n    [style.color]=\"selectedTab.id === tab.id ? colorSelected : color\"\n    [class.selected]=\"selectedTab.id === tab.id\"\n    (click)=\"selectTab(tab)\"\n    [ngStyle]=\"{ cursor: tab.disabled ? 'not-allowed' : 'pointer' }\"\n  >\n    @if(tabTemplates[tab.id]) {\n    <ng-template *ngTemplateOutlet=\"tabTemplates[tab.id]\"></ng-template>\n    } @else{\n    {{ tab.nameEn }}}\n    <span\n      class=\"underline\"\n      [style.backgroundColor]=\"colorSelected\"\n      [class.visible]=\"selectedTab.id === tab.id\"\n    ></span>\n  </button>\n  }\n</div>\n", styles: [".tab-container{display:flex;gap:1.5em;padding-top:.5rem;padding-bottom:1.25rem;margin:.5rem 0;font-size:1.25em}.tab-button{position:relative;padding-bottom:.25rem;font-weight:300;background:none;border:none;outline:none;transition:color .2s;font-family:var(--FM-Light)}.tab-button.selected{cursor:default;font-family:var(--FM-Bold)}.underline{content:\"\";position:absolute;left:0;bottom:-.25rem;height:.1em;width:100%;border-radius:4px;transform:scaleX(0);opacity:0;transition:transform .3s,opacity .3s}.underline.visible{transform:scaleX(1);opacity:1}\n"], dependencies: [{ kind: "ngmodule", type: CommonModule }, { kind: "directive", type: i1$2.NgTemplateOutlet, selector: "[ngTemplateOutlet]", inputs: ["ngTemplateOutletContext", "ngTemplateOutlet", "ngTemplateOutletInjector"] }, { kind: "directive", type: i1$2.NgStyle, selector: "[ngStyle]", inputs: ["ngStyle"] }] });
}
...
i0.ɵɵngDeclareClassMetadata({ minVersion: "12.0.0", version: "19.2.14", ngImport: i0, type: CustomFilterDropdownComponent, decorators: [{
        ...
        }], ctorParameters: () => [{ type: i1$3.FormBuilder }], propDecorators: { filtersConfig: [{
                type: Input,
                args: [{ required: true }]
            }], filtersChanged: [{
                type: Output
...
i0.ɵɵngDeclareClassMetadata({ minVersion: "12.0.0", version: "19.2.14", ngImport: i0, type: CustomFilterDynamicFormComponent, decorators: [{
        ...
        }], ctorParameters: () => [{ type: i1$3.FormBuilder }], propDecorators: { formChanged: [{
                type: Output
            }], formReset: [{
                type: Output
            }] } });
...
class CustomPlaceHolderComponent {
    text = '';
    static ɵfac = i0.ɵɵngDeclareFactory({ minVersion: "12.0.0", version: "19.2.14", ngImport: i0, type: CustomPlaceHolderComponent, deps: [], target: i0.ɵɵFactoryTarget.Component });
    static ɵcmp = i0.ɵɵngDeclareComponent({ minVersion: "14.0.0", version: "19.2.14", type: CustomPlaceHolderComponent, isStandalone: true, selector: "custom-place-holder", inputs: { text: "text" }, ngImport: i0, template: "<div class=\"placeholder-container\">\n  <p>{{ text }}</p>\n</div>\n", styles: [".placeholder-container{display:flex;justify-content:center;align-items:center;height:100%;width:100%;min-height:20vh;min-width:50vw}\n"] });
}
i0.ɵɵngDeclareClassMetadata({ minVersion: "12.0.0", version: "19.2.14", ngImport: i0, type: CustomPlaceHolderComponent, decorators: [{
            type: Component,
