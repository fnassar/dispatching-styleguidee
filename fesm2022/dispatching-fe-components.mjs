...
const showSuccess = [
    ...
    transition('void => visible', [
        animate('2s ease-in-out', keyframes([
            style({ opacity: 0, height: '7.5em', offset: 0 }),
...
const hideConfirm = [
    ...
    transition('visible => void', [
        group([
            ...
            query('.slide-element', [
                animate('2s ease-in-out', keyframes([
                    style({ opacity: 1, height: '7.5em', offset: 0 }),
                    style({ opacity: 0.5, height: '5em', offset: 0.5 }),
                    style({ opacity: 0, height: '20em', offset: 1 }),
                ])),
            ], { optional: true }),
        ]),
    ]),
