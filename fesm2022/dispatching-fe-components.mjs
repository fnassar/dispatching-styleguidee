...
import { Injectable, signal, computed, InjectionToken, Optional, Inject, inject, PLATFORM_ID, input, Input, Component, EventEmitter, Output, HostListener, Directive, ContentChild, effect, ViewChild, HostBinding } from '@angular/core';
...
import { isPlatformBrowser, CommonModule, NgStyle, NgComponentOutlet, NgClass, NgTemplateOutlet } from '@angular/common';
...
class CommonHttpService {
    ...
    CommonPostRequests(url, body) {
        return this.http.post(this.buildUrl(url), body);
    }
    CommonPutRequests(url, body) {
        return this.http.put(this.buildUrl(url), body);
    }
    CommonGetRequests(url, body) {
        return this.http.get(this.buildUrl(url), body);
    }
    CommonDeleteRequest(url) {
        return this.http.delete(this.buildUrl(url));
    }
    CommonGetRequestsWithQuery(url, Model, body) {
        if (Model) {
...
class CustomAppErrorComponent {
    ...
    shouldShowError(item) {
        return item.errorType.some(error => this.control.hasError(error) &&
            ...
            (this.control.touched || this.control.dirty) || this.showErrors());
    }
    ...
    static ɵcmp = i0.ɵɵngDeclareComponent({ minVersion: "17.0.0", version: "19.2.14", type: CustomAppErrorComponent, isStandalone: true, selector: "custom-app-error", inputs: { control: { classPropertyName: "control", publicName: "control", isSignal: false, isRequired: true, transformFunction: null }, validation: { classPropertyName: "validation", publicName: "validation", isSignal: false, isRequired: true, transformFunction: null }, name: { classPropertyName: "name", publicName: "name", isSignal: false, isRequired: true, transformFunction: null }, showErrors: { classPropertyName: "showErrors", publicName: "showErrors", isSignal: true, isRequired: false, transformFunction: null } }, ngImport: i0, template: "@for (item of validation; track $index) {\n  @if (shouldShowError(item)) {\n    <span role=\"alert\" class=\"error-message\">\n      {{ getErrorMessage(item) | translate }}\n    </span>\n  }\n}\n", styles: [".error-message{color:#d32f2f!important;font-size:.8rem;margin-top:4px;font-weight:500;display:block}\n"], dependencies: [{ kind: "ngmodule", type: TranslateModule }, { kind: "pipe", type: i1$1.TranslatePipe, name: "translate" }] });
}
i0.ɵɵngDeclareClassMetadata({ minVersion: "12.0.0", version: "19.2.14", ngImport: i0, type: CustomAppErrorComponent, decorators: [{
            type: Component,
            args: [{ selector: 'custom-app-error', imports: [TranslateModule], standalone: true, template: "@for (item of validation; track $index) {\n  @if (shouldShowError(item)) {\n    <span role=\"alert\" class=\"error-message\">\n      {{ getErrorMessage(item) | translate }}\n    </span>\n  }\n}\n", styles: [".error-message{color:#d32f2f!important;font-size:.8rem;margin-top:4px;font-weight:500;display:block}\n"] }]
...
class CustomBreadcrumbComponent {
    ...
    static ɵfac = i0.ɵɵngDeclareFactory({ minVersion: "12.0.0", version: "19.2.14", ngImport: i0, type: CustomBreadcrumbComponent, deps: [{ token: i1$4.Router }], target: i0.ɵɵFactoryTarget.Component });
...
i0.ɵɵngDeclareClassMetadata({ minVersion: "12.0.0", version: "19.2.14", ngImport: i0, type: CustomBreadcrumbComponent, decorators: [{
        ...
        }], ctorParameters: () => [{ type: i1$4.Router }], propDecorators: { breadcrumbItems: [{
                type: Input,
                args: [{ required: true }]
...
class CustomTimeInputFormComponent {
    ...
    setFormValue() {
        if (this.selectedHour && this.selectedMinute) {
            this.parentForm.get(this.controlName)?.setValue(`${this.selectedHour}:${this.selectedMinute}:00`);
            //   this.parentForm.get(this.controlName)?.setValue({
    ...
    displayTime() {
        return (`${this.selectedHour?.toString().padStart(2, '0') || '--'}:${this.selectedMinute
            ?.toString()
            .padStart(2, '0') || '--'} ` || null);
        //${this.selectedPeriod}
        // return {
...
class CustomDynamicTableWithCategoriesComponent {
    ...
    static ɵcmp = i0.ɵɵngDeclareComponent({ minVersion: "17.0.0", version: "19.2.14", type: CustomDynamicTableWithCategoriesComponent, isStandalone: true, selector: "custom-dynamic-table-with-categories", inputs: { config: "config", hasCheckBox: "hasCheckBox", cellTemplates: "cellTemplates", actionTemplates: "actionTemplates" }, outputs: { sortColumn: "sortColumn" }, ngImport: i0, template: "<table class=\"striped-table\">\n  <thead>\n    <tr>\n      @if(hasCheckBox){\n      <th>\n        <div class=\"check-box-container\">\n          <input id=\"checkbox\" class=\"custom-checkbox\" type=\"checkbox\" />\n        </div>\n      </th>\n\n      } @for(column of config.columns; track $index) {\n      <th>\n        <div class=\"table-header-cell\">\n          {{ column.label | translate }}\n          @if(column.sort){\n          <div\n            [innerHTML]=\"checkedSortIcon\"\n            class=\"sort-icon\"\n            (click)=\"sortColumn.emit(column)\"\n          ></div>\n          }\n        </div>\n      </th>\n\n      } @if(config.actions?.length) {\n\n      <th class=\"actions-width\">\n        <div class=\"table-header-cell\">\n          {{ \"Actions\" | translate }}\n        </div>\n      </th>\n      }\n    </tr>\n  </thead>\n  <tbody>\n    @if(config.groupedData?.length) { @for(group of config.groupedData; track\n    $index) {\n    <!-- Group Header -->\n    <tr (click)=\"group.isCollapsed = !group.isCollapsed\">\n      <td\n        class=\"group-header__wrapper\"\n        [attr.colspan]=\"\n          config.columns.length + (config.actions?.length ? 1 : 0)\n        \"\n      >\n        <div class=\"group-header__title-container\">\n          <div\n            [ngClass]=\"{ rotated: group.isCollapsed }\"\n            [innerHTML]=\"expandSvg\"\n            class=\"group-header__expand-icon\"\n          ></div>\n          <p class=\"group-header__title\">\n            {{ group.title }} ({{ group.items.length }})\n          </p>\n        </div>\n      </td>\n    </tr>\n\n    <!-- Group Rows -->\n    @if(!group.isCollapsed) { @for(row of group.items; track $index) {\n    <tr>\n      <!-- Columns -->\n      <td>\n        <div class=\"check-box-container\">\n          <input id=\"checkbox\" class=\"custom-checkbox\" type=\"checkbox\" />\n        </div>\n      </td>\n      @for(col of config.columns; track $index) {\n      <td [class]=\"col.customClass\">\n        @if(cellTemplates[col.key]) {\n        <ng-template\n          *ngTemplateOutlet=\"\n            cellTemplates[col.key];\n            context: { $implicit: row }\n          \"\n        >\n        </ng-template>\n        } @else {\n        <span style=\"font-size: 1em\">\n          {{ getNestedValue(row, col.key) }}\n        </span>\n        }\n      </td>\n      }\n\n      <!-- Actions Column -->\n\n      <td>\n        <div class=\"action-buttons\">\n          @for ( action of config.actions; track $index) {\n            <!-- @if (actionTemplates[action.label]) {\n            <ng-template\n              *ngTemplateOutlet=\"\n                actionTemplates[action.label];\n                context: { $implicit: row }\n              \"\n            >\n            </ng-template>\n            } @else {} -->\n\n            <button\n\n            style=\"padding: .5em;transform: scale(1.3);\"\n              [disabled]=\"action.isDisabled?.(row)\"\n              (click)=\"onAction(row, action.handler)\"\n            >\n\n              <img [src]=\"action.iconPath\" alt=\"\">\n            </button>\n\n          }\n        </div>\n      </td>\n    </tr>\n    } } } }\n  </tbody>\n</table>\n", styles: [".striped-table{margin:.5em;overflow:hidden;background-color:#fff}.striped-table thead{color:#4b4b4b;text-align:left;border-bottom:2px solid #eeeeee;font-size:1.3em}.striped-table th{padding:10px;border:1px solid #eeeeee}.striped-table tbody tr{font-weight:500;font-size:1.2}.striped-table td{padding:.8em .5em;color:#4b4b4b;font-size:1.2;border:1px solid #eeeeee}.table-header-cell{display:flex;flex-direction:row;justify-content:flex-start;gap:.5em;align-items:center;font-size:.9em;color:#4b4b4b}.sort-icon{height:1.5em;display:flex;align-items:center;justify-content:center;overflow:auto;cursor:pointer}.group-header__wrapper{border:none!important}.group-header__title-container{display:flex;align-items:center}.group-header__expand-icon{transform:scale(.8);cursor:pointer}.group-header__title{margin-top:.8em;margin-bottom:.8em;font-size:1.2em;font-weight:900;margin-inline-start:.5em;color:#000}.rotated{transform:rotate(180deg)}th:first-child,td:first-child{width:1%}.check-box-container{margin-top:.5em}.custom-checkbox{transform:scale(.5em);appearance:none;width:1.5rem;height:1.6rem;border:1px solid #ccc;border-radius:.3em;position:relative;outline:none;cursor:pointer;transition:border-color .3s ease,background-color .3s ease}.custom-checkbox:focus{border-color:#25c7bc}.custom-checkbox:checked{background-color:#25c7bc;border-color:#25c7bc}.custom-checkbox:checked:after{content:\"\";position:absolute;top:25%;inset-inline-start:50%;transform:translate(-50%,-25%) rotate(45deg);width:.5rem;height:1rem;border:solid white;border-width:0 .2em .2em 0}.custom-checkbox:disabled{cursor:not-allowed}.action-buttons{display:flex;gap:.5em}\n"], dependencies: [{ kind: "ngmodule", type: TranslateModule }, { kind: "pipe", type: i1$1.TranslatePipe, name: "translate" }, { kind: "directive", type: NgClass, selector: "[ngClass]", inputs: ["class", "ngClass"] }, { kind: "directive", type: NgTemplateOutlet, selector: "[ngTemplateOutlet]", inputs: ["ngTemplateOutletContext", "ngTemplateOutlet", "ngTemplateOutletInjector"] }] });
}
...
class CustomAvatarsComponent {
    ...
    static ɵcmp = i0.ɵɵngDeclareComponent({ minVersion: "17.0.0", version: "19.2.14", type: CustomAvatarsComponent, isStandalone: true, selector: "custom-avatars", inputs: { items: "items", size: "size", overlapOffset: "overlapOffset" }, ngImport: i0, template: "<div class=\"avatar-list\">\n  @for(item of items; track $index) {\n    <div\n      class=\"avatar-item\"\n      [style.width.px]=\"size\"\n      [style.height.px]=\"size\"\n      [title]=\"item.name\"\n      [style.transform]=\"'translateX(' + (- $index * overlapOffset) + 'px)'\"\n       [style.zIndex]=\"items.length - $index\"\n    >\n      @switch(!!item.imgPath) {\n        @case(true) {\n          <img\n            [src]=\"item.imgPath\"\n            [alt]=\"item.name\"\n            class=\"avatar-img\"\n            [style.width.px]=\"size\"\n            [style.height.px]=\"size\"\n\n          />\n        }\n        @default {\n          <div\n            class=\"avatar-initials\"\n            [style.width.px]=\"size\"\n            [style.height.px]=\"size\"\n            [style.fontSize.px]=\"size / 2\"\n          >\n            {{ getInitials(item.name) }}\n          </div>\n        }\n      }\n    </div>\n  }\n</div>\n", styles: [".avatar-list{display:flex;align-items:center}.avatar-item{position:relative;border-radius:50%;overflow:hidden;flex-shrink:0;border:solid 2px #fff;box-shadow:0 0 0 1px #0000001a}.avatar-img{object-fit:cover;display:block}.avatar-initials{display:flex;justify-content:center;align-items:center;background-color:#bbb;color:#fff;font-weight:700}\n"] });
}
i0.ɵɵngDeclareClassMetadata({ minVersion: "12.0.0", version: "19.2.14", ngImport: i0, type: CustomAvatarsComponent, decorators: [{
            type: Component,
            args: [{ selector: 'custom-avatars', imports: [], template: "<div class=\"avatar-list\">\n  @for(item of items; track $index) {\n    <div\n      class=\"avatar-item\"\n      [style.width.px]=\"size\"\n      [style.height.px]=\"size\"\n      [title]=\"item.name\"\n      [style.transform]=\"'translateX(' + (- $index * overlapOffset) + 'px)'\"\n       [style.zIndex]=\"items.length - $index\"\n    >\n      @switch(!!item.imgPath) {\n        @case(true) {\n          <img\n            [src]=\"item.imgPath\"\n            [alt]=\"item.name\"\n            class=\"avatar-img\"\n            [style.width.px]=\"size\"\n            [style.height.px]=\"size\"\n\n          />\n        }\n        @default {\n          <div\n            class=\"avatar-initials\"\n            [style.width.px]=\"size\"\n            [style.height.px]=\"size\"\n            [style.fontSize.px]=\"size / 2\"\n          >\n            {{ getInitials(item.name) }}\n          </div>\n        }\n      }\n    </div>\n  }\n</div>\n", styles: [".avatar-list{display:flex;align-items:center}.avatar-item{position:relative;border-radius:50%;overflow:hidden;flex-shrink:0;border:solid 2px #fff;box-shadow:0 0 0 1px #0000001a}.avatar-img{object-fit:cover;display:block}.avatar-initials{display:flex;justify-content:center;align-items:center;background-color:#bbb;color:#fff;font-weight:700}\n"] }]
...
class CustomProgressBarComponent {
    ...
    static ɵcmp = i0.ɵɵngDeclareComponent({ minVersion: "14.0.0", version: "19.2.14", type: CustomProgressBarComponent, isStandalone: true, selector: "custom-progress-bar", inputs: { value: "value", color: "color", emptyColor: "emptyColor" }, ngImport: i0, template: "<div style=\"display: flex;justify-content: center;align-items: center;\">\n\n  <div class=\"progress-bar-container\"   [ngStyle]=\"{\n        'background-color': emptyColor\n      }\">\n    <div\n      class=\"progress-bar-fill\"\n      [ngStyle]=\"{\n        'width.%': value,\n        'background-color': color\n      }\"\n    ></div>\n  </div>\n  <div class=\"progress-bar-label\">{{ value }}%</div>\n</div>\n", styles: [".progress-bar-container{width:100%;background:#f0f0f0;height:8px;border-radius:4px;overflow:hidden}.progress-bar-fill{height:100%;border-radius:4px;transition:width .3s ease}.progress-bar-label{font-size:1em;text-align:right;margin-inline-start:.5em}\n"], dependencies: [{ kind: "directive", type: NgStyle, selector: "[ngStyle]", inputs: ["ngStyle"] }] });
}
i0.ɵɵngDeclareClassMetadata({ minVersion: "12.0.0", version: "19.2.14", ngImport: i0, type: CustomProgressBarComponent, decorators: [{
            type: Component,
            args: [{ selector: 'custom-progress-bar', imports: [NgStyle], template: "<div style=\"display: flex;justify-content: center;align-items: center;\">\n\n  <div class=\"progress-bar-container\"   [ngStyle]=\"{\n        'background-color': emptyColor\n      }\">\n    <div\n      class=\"progress-bar-fill\"\n      [ngStyle]=\"{\n        'width.%': value,\n        'background-color': color\n      }\"\n    ></div>\n  </div>\n  <div class=\"progress-bar-label\">{{ value }}%</div>\n</div>\n", styles: [".progress-bar-container{width:100%;background:#f0f0f0;height:8px;border-radius:4px;overflow:hidden}.progress-bar-fill{height:100%;border-radius:4px;transition:width .3s ease}.progress-bar-label{font-size:1em;text-align:right;margin-inline-start:.5em}\n"] }]
        }], propDecorators: { value: [{
                type: Input
            }], color: [{
                type: Input
...
class PermissionGuard {
    ...
    static ɵfac = i0.ɵɵngDeclareFactory({ minVersion: "12.0.0", version: "19.2.14", ngImport: i0, type: PermissionGuard, deps: [{ token: i1$4.Router }], target: i0.ɵɵFactoryTarget.Injectable });
