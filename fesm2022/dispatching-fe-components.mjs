...
class CustomFileUploadComponent {
    ...
    async onFileSelected($event) {
        if (this.maxFileCount &&
            ...
            console.log('max files is ', this.maxFileCount);
            return;
        }
