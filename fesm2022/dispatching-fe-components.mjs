...
class CustomTableComponent {
    ...
    constructor(sanitizer) {
        ...
        this.checkedSortIcon = this.sanitizer.bypassSecurityTrustHtml(sortSvg$1);
        this.checkedActionViewSvg =
            this.sanitizer.bypassSecurityTrustHtml(actionViewSvg$1);
        this.checkedActionEditSvg =
            this.sanitizer.bypassSecurityTrustHtml(actionEditSvg$1);
    ...
    static ɵcmp = i0.ɵɵngDeclareComponent({ minVersion: "17.0.0", version: "19.2.15", type: CustomTableComponent, isStandalone: true, selector: "custom-table", inputs: { tableData: "tableData", tableHeader: "tableHeader", cellTemplates: "cellTemplates", expandedChildAccessor: "expandedChildAccessor", expandable: "expandable", showStatusColumn: "showStatusColumn", showActionColumn: "showActionColumn", showNumberCol: "showNumberCol", pagination: "pagination", enableEdit: "enableEdit", enableDelete: "enableDelete", enableView: "enableView", rowClass: "rowClass", headerClass: "headerClass", expandedCellTemplates: "expandedCellTemplates", statusCol: "statusCol" }, outputs: { onEdit: "onEdit", onView: "onView", onDelete: "onDelete", onRowClick: "onRowClick", sortColumn: "sortColumn" }, ngImport: i0, template: "<div class=\"table-container\">\n  <table class=\"striped-table\">\n    <thead [class]=\"headerClass\">\n      <tr>\n\n        @if (showNumberCol) {\n        <th class=\"number-col\">\n          <div class=\"table-header-cell\">#</div>\n        </th>\n        }\n\n        @for (col of tableHeader; track $index; let colIndex = $index) {\n        <th>\n          <div class=\"table-header-cell\">\n            {{ col.header }}\n\n            @if (col.sort) {\n            <span class=\"sort-icon\" [innerHTML]=\"checkedSortIcon\" (click)=\"sortColumn.emit(col.body)\">\n            </span>\n            }\n          </div>\n        </th>\n        }\n\n        @if (showStatusColumn) {\n        <th>Status</th>\n        }\n        @if (showActionColumn) {\n        <th>Actions</th>\n        }\n\n      </tr>\n    </thead>\n\n    <tbody>\n\n      @for (item of tableData; track $index; let rowIndex = $index) {\n\n      <tr [class]=\"rowClass\" (click)=\"onRowClick.emit(item)\">\n\n        @if (showNumberCol) {\n        <td class=\"table-td-number\">\n          {{ rowIndex + 1 + (pagination.pageNum - 1) * pagination.pageSize }}\n        </td>\n        }\n\n        @for (col of tableHeader; track $index; let colIndex = $index) {\n\n        @if (col.htmlRef && cellTemplates[col.htmlRef]) {\n\n        <td class=\"table-td\">\n          <div class=\"flex items-center\">\n\n            @if (colIndex == 0) {\n\n            <div class=\"w-[1.5em] h-[1em] flex items-center justify-center\">\n\n              @if (expandable && canExpandRow(item)) {\n\n              <span style=\"cursor:pointer;\" (click)=\"toggleRow(rowIndex); $event.stopPropagation()\"\n                class=\"cursor-pointer hover:scale-105 rotate-270\"\n                [ngClass]=\"{ 'rotate-none': isRowExpanded(rowIndex) }\">\n\n                <svg width=\"16\" height=\"16\" viewBox=\"0 0 16 16\" fill=\"none\">\n                  <path d=\"M4 6L8 10L12 6\" stroke=\"#120710\" stroke-width=\"1.5\" stroke-linecap=\"round\"\n                    stroke-linejoin=\"round\" />\n                </svg>\n\n              </span>\n\n              } @else {\n\n              <span class=\"inline-block w-[1em] h-[1em] opacity-0\"></span>\n\n              }\n\n            </div>\n\n            }\n\n            <ng-template [ngTemplateOutlet]=\"cellTemplates[col.htmlRef]\"\n              [ngTemplateOutletContext]=\"{ $implicit: item }\">\n            </ng-template>\n\n          </div>\n        </td>\n\n        }\n\n        @else if (col.inputTransform) {\n        <td class=\"table-td\">{{ col.inputTransform(item) }}</td>\n        }\n\n        @else {\n        <td class=\"table-td\">{{ getCellValue(item, col) }}</td>\n        }\n\n        }\n\n        @if (showStatusColumn) {\n        <td class=\"status-td\">\n          <div class=\"status\">\n            @if (item[statusCol.header] === statusCol.trueValue) {\n            <div class=\"true\">{{ statusCol.trueText }}</div>\n            } @else {\n            <div class=\"false\">{{ statusCol.falseText }}</div>\n            }\n          </div>\n        </td>\n        }\n\n        @if (showActionColumn) {\n        <td class=\"table-td\">\n          <div class=\"actions\">\n            <svg width=\"16\" height=\"16\" viewBox=\"0 0 16 16\" fill=\"none\" xmlns=\"http://www.w3.org/2000/svg\">\n              <path\n                d=\"M3.33333 6.66675C2.6 6.66675 2 7.26675 2 8.00008C2 8.73341 2.6 9.33341 3.33333 9.33341C4.06667 9.33341 4.66667 8.73341 4.66667 8.00008C4.66667 7.26675 4.06667 6.66675 3.33333 6.66675Z\"\n                fill=\"#120710\" />\n              <path\n                d=\"M12.6663 6.66675C11.933 6.66675 11.333 7.26675 11.333 8.00008C11.333 8.73341 11.933 9.33341 12.6663 9.33341C13.3997 9.33341 13.9997 8.73341 13.9997 8.00008C13.9997 7.26675 13.3997 6.66675 12.6663 6.66675Z\"\n                fill=\"#120710\" />\n              <path\n                d=\"M8.00033 6.66675C7.26699 6.66675 6.66699 7.26675 6.66699 8.00008C6.66699 8.73341 7.26699 9.33341 8.00033 9.33341C8.73366 9.33341 9.33366 8.73341 9.33366 8.00008C9.33366 7.26675 8.73366 6.66675 8.00033 6.66675Z\"\n                fill=\"#120710\" />\n            </svg>\n\n            <!-- @if (enableView) {\n            <span class=\"actions-icon-wrapper\" (click)=\"$event.stopPropagation(); onView.emit(item)\"\n              [innerHTML]=\"checkedActionViewSvg\">\n            </span>\n            }\n            @if (enableEdit) {\n            <span class=\"actions-icon-wrapper\" (click)=\"$event.stopPropagation(); onEdit.emit(item)\"\n              [innerHTML]=\"checkedActionEditSvg\">\n            </span>\n            }\n            @if (enableDelete) {\n            <span class=\"actions-icon-wrapper\" style=\"transform:scale(.9)\"\n              (click)=\"$event.stopPropagation(); onDelete.emit(item)\" [innerHTML]=\"checkedActionDeleteSvg\">\n            </span>\n            } -->\n          </div>\n        </td>\n        }\n\n      </tr>\n\n      @if (expandable && isRowExpanded(rowIndex) && canExpandRow(item)) {\n\n      @for (child of expandedChildAccessor!(item); track child.id) {\n\n      <tr class=\"expanded-child-row\">\n\n        @if (showNumberCol) {\n        <td></td>\n        }\n\n        @for (col of tableHeader; track $index; let colIndex = $index) {\n\n        <td class=\"table-td\">\n\n          @if (col.expandedHtmlRef && expandedCellTemplates[col.expandedHtmlRef]) {\n          <div class=\"flex items-center\">\n            <ng-template [ngTemplateOutlet]=\"expandedCellTemplates[col.expandedHtmlRef]\"\n              [ngTemplateOutletContext]=\"{ $implicit: child,parent:item }\">\n            </ng-template>\n          </div>\n          }\n\n          @else if (col.htmlRef && cellTemplates[col.htmlRef]) {\n          <ng-template [ngTemplateOutlet]=\"cellTemplates[col.htmlRef]\"\n            [ngTemplateOutletContext]=\"{ $implicit: child, parent:item }\">\n          </ng-template>\n          }\n\n          @else if (col.inputTransform) {\n          {{ col.inputTransform(child) }}\n          }\n\n          @else {\n          {{ getCellValue(child, col) }}\n          }\n        </td>\n\n\n        }\n\n        <!-- match action/status cell counts -->\n        @if (showStatusColumn) {\n        <td></td>\n        }\n        @if (showActionColumn) {\n        <td></td>\n        }\n\n      </tr>\n\n      }\n\n      }\n\n      }\n\n    </tbody>\n  </table>\n</div>", styles: [".table-container{overflow-x:auto;overflow-y:hidden;width:100%;max-width:100%}.striped-table{width:100%;min-width:900px;background-color:#fff}.actions-icon-wrapper{width:2em;height:1.4em}.actions-icon-wrapper svg{width:100%;height:auto;display:block}.table-header-cell{display:flex;flex-direction:row;justify-content:flex-start;gap:.5em;align-items:center;font-size:1em}.sort-icon{width:1em;cursor:pointer;height:1.125em}.sort-icon svg{width:100%!important;height:auto;display:block}.toggle-button{background:none;border:none;color:#25c7bc;cursor:pointer;font-weight:600}.actions{display:flex;justify-content:start;align-items:center;gap:10px;cursor:pointer}.status-td{padding:.1em .4em!important}.status{height:100%;display:flex;justify-content:center;align-items:center}.status div{display:flex;justify-content:center;align-items:center;padding:.25em 0;border:0px solid transparent;border-radius:1em;width:6em;font-family:var(--FM-Bold)}.true{color:#0d7d0b;background-color:#c8ffc7}.false{color:#d2344f;background-color:#ffe0e5}.striped-table thead{text-align:left}.striped-table th{padding:.35em 1em;border-bottom:2px solid var(--grey-700);font-size:1em;font-family:var(--FM-Medium);line-height:1.5em;color:var(--grey-800);font-weight:500}.striped-table tbody tr{font-weight:500;font-size:1em}.striped-table td{padding:0 1em;color:var(--grey-800);border-bottom:1px solid var(--grey-700)}.active{background-color:#c8ffc7;width:85px;height:28px;border-radius:100px;display:flex;justify-self:center;align-items:center;font-size:.67em;font-weight:500;color:#0d7d0b;text-align:center}.inactive{background-color:#ffe0e5;width:85px;height:28px;border-radius:100px;display:flex;justify-content:center;align-items:center;font-size:.67em;font-weight:500;color:#d2344f;text-align:center}.table-td{font-family:var(--FM-Medium);font-size:1em;text-align:left;color:var(--grey-800)}tr:has(>td.table-td-number:first-child)>td:nth-child(2){background-color:#fcfbfb;font-family:var(--FM-Medium)!important;border-left:0px solid #eeeeee;text-align:start}tr:not(:has(>td.table-td-number:first-child))>td:first-child{font-family:var(--FM-Medium)!important;border-left:0px solid #eeeeee;text-align:start}.child-cell{font-family:var(--FM-Medium)!important;font-size:1.15em}\n"], dependencies: [{ kind: "ngmodule", type: CommonModule }, { kind: "directive", type: i1$2.NgClass, selector: "[ngClass]", inputs: ["class", "ngClass"] }, { kind: "directive", type: i1$2.NgTemplateOutlet, selector: "[ngTemplateOutlet]", inputs: ["ngTemplateOutletContext", "ngTemplateOutlet", "ngTemplateOutletInjector"] }] });
}
