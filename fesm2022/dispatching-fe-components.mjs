...
class AuthService {
    ...
    getCurrentUser() {
        ...
        return this.authContextService.userLocalData$() || userData ? JSON.parse(userData) : {};
    }
    ...
    hasCategory(route) {
        ...
        if (listOfPermissions && listOfPermissions.length > 0) {
            return requiredPermissions.some((p) => listOfPermissions?.includes(p) || false);
        }
        return false;
    }
    canDoAction(action) {
        ...
        const listOfRoles = this.getCurrentPermissions();
        // console.log('list of roles', listOfRoles);
        if (listOfRoles && listOfRoles.length > 0) {
            return (requiredAction.some((action) => listOfRoles.includes(action)) || false);
        }
        return false;
    }
    static ɵfac = i0.ɵɵngDeclareFactory({ minVersion: "12.0.0", version: "19.2.14", ngImport: i0, type: AuthService, deps: [{ token: AuthContextService }, { token: AuthBeService }, { token: i1$1.Router }, { token: StorageService }], target: i0.ɵɵFactoryTarget.Injectable });
...
i0.ɵɵngDeclareClassMetadata({ minVersion: "12.0.0", version: "19.2.14", ngImport: i0, type: AuthService, decorators: [{
        ...
        }], ctorParameters: () => [{ type: AuthContextService }, { type: AuthBeService }, { type: i1$1.Router }, { type: StorageService }] });
...
class AuthDirective {
    ...
    set canDoAction(actions) {
        const allowed = this.authService.canDoAction(actions);
        // console.log('needed action', actions);
    ...
    static ɵfac = i0.ɵɵngDeclareFactory({ minVersion: "12.0.0", version: "19.2.14", ngImport: i0, type: AuthDirective, deps: [{ token: AuthService }, { token: i0.TemplateRef }, { token: i0.ViewContainerRef }], target: i0.ɵɵFactoryTarget.Directive });
    static ɵdir = i0.ɵɵngDeclareDirective({ minVersion: "14.0.0", version: "19.2.14", type: AuthDirective, isStandalone: true, selector: "[canDoAction]", inputs: { canDoAction: "canDoAction" }, ngImport: i0 });
}
i0.ɵɵngDeclareClassMetadata({ minVersion: "12.0.0", version: "19.2.14", ngImport: i0, type: AuthDirective, decorators: [{
        ...
        }], ctorParameters: () => [{ type: AuthService }, { type: i0.TemplateRef }, { type: i0.ViewContainerRef }], propDecorators: { canDoAction: [{
                type: Input
            }] } });
...
i0.ɵɵngDeclareClassMetadata({ minVersion: "12.0.0", version: "19.2.14", ngImport: i0, type: CustomTableComponent, decorators: [{
        ...
        }], ctorParameters: () => [{ type: i1$5.DomSanitizer }], propDecorators: { tableData: [{
                type: Input,
                args: [{ required: false }]
            }], tableCategories: [{
                type: Input,
...
class CustomBreadcrumbComponent {
    ...
    static ɵfac = i0.ɵɵngDeclareFactory({ minVersion: "12.0.0", version: "19.2.14", ngImport: i0, type: CustomBreadcrumbComponent, deps: [{ token: i1$1.Router }], target: i0.ɵɵFactoryTarget.Component });
...
i0.ɵɵngDeclareClassMetadata({ minVersion: "12.0.0", version: "19.2.14", ngImport: i0, type: CustomBreadcrumbComponent, decorators: [{
        ...
        }], ctorParameters: () => [{ type: i1$1.Router }], propDecorators: { breadcrumbItems: [{
                type: Input,
                args: [{ required: true }]
...
i0.ɵɵngDeclareClassMetadata({ minVersion: "12.0.0", version: "19.2.14", ngImport: i0, type: CustomFileUploadComponent, decorators: [{
        ...
        }], ctorParameters: () => [{ type: i1$5.DomSanitizer }], propDecorators: { parentForm: [{
                type: Input,
                args: [{ required: true }]
            }], FileTypes: [{
                type: Input,
...
class CustomFileViewerComponent {
    ...
    static ɵfac = i0.ɵɵngDeclareFactory({ minVersion: "12.0.0", version: "19.2.14", ngImport: i0, type: CustomFileViewerComponent, deps: [{ token: i1$5.DomSanitizer }], target: i0.ɵɵFactoryTarget.Component });
...
i0.ɵɵngDeclareClassMetadata({ minVersion: "12.0.0", version: "19.2.14", ngImport: i0, type: CustomFileViewerComponent, decorators: [{
        ...
        }], ctorParameters: () => [{ type: i1$5.DomSanitizer }], propDecorators: { file: [{
                type: Input,
                args: [{ required: true }]
            }], showMenu: [{
                type: Input
...
class CustomSteppersContainerComponent {
    ...
    static ɵfac = i0.ɵɵngDeclareFactory({ minVersion: "12.0.0", version: "19.2.14", ngImport: i0, type: CustomSteppersContainerComponent, deps: [{ token: StepperService }, { token: i1$5.DomSanitizer }], target: i0.ɵɵFactoryTarget.Component });
...
i0.ɵɵngDeclareClassMetadata({ minVersion: "12.0.0", version: "19.2.14", ngImport: i0, type: CustomSteppersContainerComponent, decorators: [{
        ...
        }], ctorParameters: () => [{ type: StepperService }, { type: i1$5.DomSanitizer }], propDecorators: { steps: [{
                type: Input
            }] } });
...
i0.ɵɵngDeclareClassMetadata({ minVersion: "12.0.0", version: "19.2.14", ngImport: i0, type: CustomFieldsFormComponent, decorators: [{
        ...
        }], ctorParameters: () => [{ type: i1$4.FormBuilder }], propDecorators: { parentForm: [{
                type: Input,
                args: [{ required: true }]
            }], controlName: [{
                type: Input,
...
i0.ɵɵngDeclareClassMetadata({ minVersion: "12.0.0", version: "19.2.14", ngImport: i0, type: CustomConfirmPopupComponent, decorators: [{
        ...
        }], ctorParameters: () => [{ type: i1$5.DomSanitizer }], propDecorators: { message: [{
                type: Input,
                args: [{ required: true }]
            }], type: [{
                type: Input,
...
i0.ɵɵngDeclareClassMetadata({ minVersion: "12.0.0", version: "19.2.14", ngImport: i0, type: CustomDynamicTableWithCategoriesComponent, decorators: [{
        ...
        }], ctorParameters: () => [{ type: i1$5.DomSanitizer }], propDecorators: { config: [{
                type: Input
            }], hasCheckBox: [{
                type: Input
            }], cellTemplates: [{
...
class CustomDropdownButtonComponent {
    ...
    static ɵfac = i0.ɵɵngDeclareFactory({ minVersion: "12.0.0", version: "19.2.14", ngImport: i0, type: CustomDropdownButtonComponent, deps: [{ token: i1$5.DomSanitizer }], target: i0.ɵɵFactoryTarget.Component });
...
i0.ɵɵngDeclareClassMetadata({ minVersion: "12.0.0", version: "19.2.14", ngImport: i0, type: CustomDropdownButtonComponent, decorators: [{
        ...
        }], ctorParameters: () => [{ type: i1$5.DomSanitizer }], propDecorators: { options: [{
                type: Input,
                args: [{ required: true }]
            }], selected: [{
                type: Output
...
class CustomDetailsHeaderComponent {
    ...
    static ɵfac = i0.ɵɵngDeclareFactory({ minVersion: "12.0.0", version: "19.2.14", ngImport: i0, type: CustomDetailsHeaderComponent, deps: [{ token: i1$5.DomSanitizer }], target: i0.ɵɵFactoryTarget.Component });
...
i0.ɵɵngDeclareClassMetadata({ minVersion: "12.0.0", version: "19.2.14", ngImport: i0, type: CustomDetailsHeaderComponent, decorators: [{
        ...
        }], ctorParameters: () => [{ type: i1$5.DomSanitizer }], propDecorators: { showX: [{
                type: Input
            }], BreadCrumbs: [{
                type: Input,
                args: [{ required: true }]
...
class CustomTitleContentComponent {
    ...
    static ɵcmp = i0.ɵɵngDeclareComponent({ minVersion: "14.0.0", version: "19.2.14", type: CustomTitleContentComponent, isStandalone: true, selector: "custom-title-content", inputs: { title: "title", color: "color", separator: "separator" }, ngImport: i0, template: "<div class=\"title-content-container\">\n  <h1\n    class=\"title-styles\"\n    [ngClass]=\"{ 'title-border': separator }\"\n    [ngStyle]=\"{ '--title-color': color }\"\n  >\n    {{ title }}\n  </h1>\n  <div class=\"content-section\">\n    <ng-content select=\"[content]\"></ng-content>\n  </div>\n</div>\n", styles: [".title-content-container{margin:1.5em 0;padding:0 1em}.title-styles{font-size:1.25em;font-weight:600;color:var(--title-color);margin-bottom:1em;padding-bottom:.2em}.title-border{border-bottom:1px solid #00000026}.content-section{margin-top:1em;display:flex;flex-direction:column;gap:1em}\n"], dependencies: [{ kind: "ngmodule", type: CommonModule }, { kind: "directive", type: i1$3.NgClass, selector: "[ngClass]", inputs: ["class", "ngClass"] }, { kind: "directive", type: i1$3.NgStyle, selector: "[ngStyle]", inputs: ["ngStyle"] }] });
}
...
class PermissionGuard {
    ...
    canActivate(route) {
        if (this.authService.hasCategory(route)) {
            return true;
        }
        else {
            this.router.navigate(['error/403']); // TODO replace with toaster + update permission using validation api
            return false;
        }
    }
    static ɵfac = i0.ɵɵngDeclareFactory({ minVersion: "12.0.0", version: "19.2.14", ngImport: i0, type: PermissionGuard, deps: [{ token: i1$1.Router }, { token: AuthService }], target: i0.ɵɵFactoryTarget.Injectable });
