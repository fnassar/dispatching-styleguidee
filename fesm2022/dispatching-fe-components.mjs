...
import { Injectable, signal, computed, inject, PLATFORM_ID, Input, Component, EventEmitter, Output, HostListener, Directive, Inject, ContentChild, effect } from '@angular/core';
...
class CommonHttpService {
    ...
    static ɵfac = i0.ɵɵngDeclareFactory({ minVersion: "12.0.0", version: "19.2.13", ngImport: i0, type: CommonHttpService, deps: [{ token: i1.HttpClient }], target: i0.ɵɵFactoryTarget.Injectable });
...
class CustomDropdownComponent {
    ...
    filterOptions() {
        if (!this.filterText) {
            ...
            this.filteredOptions = this.options.filter((option) => option.name.toLowerCase().includes(searchText));
        }
    }
    set reset(value) {
        if (value) {
...
i0.ɵɵngDeclareClassMetadata({ minVersion: "12.0.0", version: "19.2.13", ngImport: i0, type: CustomBreadcrumbComponent, decorators: [{
        ...
        }], propDecorators: { breadcrumbItems: [{
                type: Input,
                args: [{ required: true }]
            }], breadcrumbItemClicked: [{
                type: Output
...
export { AllowNumberOnlyDirective, ArabicOnlyDirective, AuthConstant, AuthService, BlurBackdropDirective, ClickOutsideDirective, CommonHttpService, ComponentFormErrorConstant, CustomAppErrorComponent, CustomBreadcrumbComponent, CustomButtonComponent, CustomCalendarComponent, CustomCalenderFormComponent, CustomCheckBoxComponent, CustomCheckBoxFormComponent, CustomDropdownComponent, CustomDropdownFormComponent, CustomInputComponent, CustomInputFormComponent, CustomMultiSelectComponent, CustomMultiSelectFormComponent, CustomPaginationComponent, CustomPopUpComponent, CustomTableComponent, CustomTextareaComponent, CustomTextareaFormComponent, CustomToastComponent, CustomToggleSwitchComponent, CustomToggleSwitchFormComponent, EnglishOnlyDirective, ErrorInterceptor, I18nConstant, ModuleRoutes, NetworkConnectionInterceptor, OverlayPanelComponent, PermissionGuard, ToastService, ToggleElementDirective, TokenInterceptor, TranslationService, UserDataService, authGuard, b64toBlob, convertDateFormat, convertFileToBase64, convertFormGroupToFormData, diffTime, excelDateToJSDate, flattenTree, formatDate, formatDateWithTime, formatTimestamp, formatinitialTakeTime, generateRandomColor, generateUniqueNumber, getFormValidationErrors, isDocumentPath, isImagePath, isVedioPath, logger, noAuthGuard, someFieldsContainData, timeAgo };
