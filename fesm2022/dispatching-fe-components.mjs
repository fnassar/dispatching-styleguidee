...
import { Injectable, signal, computed, InjectionToken, Optional, Inject, inject, PLATFORM_ID, Input, Component, EventEmitter, Output, HostListener, Directive, ContentChild, effect, ViewChild, HostBinding, input } from '@angular/core';
...
class CustomFieldsFormComponent {
    ...
    static ɵcmp = i0.ɵɵngDeclareComponent({ minVersion: "17.0.0", version: "19.2.14", type: CustomFieldsFormComponent, isStandalone: true, selector: "custom-fields-form", inputs: { parentForm: "parentForm", controlName: "controlName" }, ngImport: i0, template: "<div [formGroup]=\"parentForm\">\n  <label class=\"custom-label\">Custom Field</label>\n  <div formArrayName=\"{{ controlName }}\">\n    @for( group of fieldsFormArrayControllers ; track $index){\n\n      <div  [formGroupName]=\"$index\" class=\"field-row\">\n        <custom-input-form\n          name=\"fieldName\"\n          controlName=\"fieldName\"\n          [parentForm]=\"group\"\n          [label]=\"'Field Name'\"\n          [validation]=\"[]\"\n          class=\"w-full\"\n        ></custom-input-form>\n\n        <custom-input-form\n          name=\"fieldValue\"\n          controlName=\"fieldValue\"\n          [parentForm]=\"group\"\n          [label]=\"'Field Value'\"\n          [validation]=\"[]\"\n          class=\"w-full\"\n        ></custom-input-form>\n\n        <button type=\"button\" class=\"remove-btn\" (click)=\"removeField($index)\">\u2715</button>\n      </div>\n    }\n  </div>\n\n  <div class=\"add-btn-container\">\n    <button type=\"button\" (click)=\"addField()\">\u2795</button>\n  </div>\n</div>\n", styles: [".field-row{display:flex;align-items:center;gap:10px;margin-top:10px}.remove-btn{color:red;font-size:18px;background:none;border:none;cursor:pointer}.add-btn-container{margin-top:10px;text-align:end}\n"], dependencies: [{ kind: "ngmodule", type: ReactiveFormsModule }, { kind: "directive", type: i1$2.NgControlStatusGroup, selector: "[formGroupName],[formArrayName],[ngModelGroup],[formGroup],form:not([ngNoForm]),[ngForm]" }, { kind: "directive", type: i1$2.FormGroupDirective, selector: "[formGroup]", inputs: ["formGroup"], outputs: ["ngSubmit"], exportAs: ["ngForm"] }, { kind: "directive", type: i1$2.FormGroupName, selector: "[formGroupName]", inputs: ["formGroupName"] }, { kind: "directive", type: i1$2.FormArrayName, selector: "[formArrayName]", inputs: ["formArrayName"] }, { kind: "component", type: CustomInputFormComponent, selector: "custom-input-form", inputs: ["class", "labelClass", "label", "placeholder", "name", "type", "controlName", "parentForm", "validation"], outputs: ["valueChange"] }] });
}
i0.ɵɵngDeclareClassMetadata({ minVersion: "12.0.0", version: "19.2.14", ngImport: i0, type: CustomFieldsFormComponent, decorators: [{
            type: Component,
            args: [{ selector: 'custom-fields-form', imports: [ReactiveFormsModule, CustomInputFormComponent], template: "<div [formGroup]=\"parentForm\">\n  <label class=\"custom-label\">Custom Field</label>\n  <div formArrayName=\"{{ controlName }}\">\n    @for( group of fieldsFormArrayControllers ; track $index){\n\n      <div  [formGroupName]=\"$index\" class=\"field-row\">\n        <custom-input-form\n          name=\"fieldName\"\n          controlName=\"fieldName\"\n          [parentForm]=\"group\"\n          [label]=\"'Field Name'\"\n          [validation]=\"[]\"\n          class=\"w-full\"\n        ></custom-input-form>\n\n        <custom-input-form\n          name=\"fieldValue\"\n          controlName=\"fieldValue\"\n          [parentForm]=\"group\"\n          [label]=\"'Field Value'\"\n          [validation]=\"[]\"\n          class=\"w-full\"\n        ></custom-input-form>\n\n        <button type=\"button\" class=\"remove-btn\" (click)=\"removeField($index)\">\u2715</button>\n      </div>\n    }\n  </div>\n\n  <div class=\"add-btn-container\">\n    <button type=\"button\" (click)=\"addField()\">\u2795</button>\n  </div>\n</div>\n", styles: [".field-row{display:flex;align-items:center;gap:10px;margin-top:10px}.remove-btn{color:red;font-size:18px;background:none;border:none;cursor:pointer}.add-btn-container{margin-top:10px;text-align:end}\n"] }]
