...
class CustomProgressRingComponent {
    ...
    static ɵcmp = i0.ɵɵngDeclareComponent({ minVersion: "14.0.0", version: "19.2.15", type: CustomProgressRingComponent, isStandalone: true, selector: "custom-progress-ring", inputs: { value: "value", total: "total" }, ngImport: i0, template: "<!-- Progress Circle -->\n<div class=\"progress-container\">\n  <svg\n    width=\"3.75em\"\n    height=\"3.75em\"\n    viewBox=\"-1 -1 38 38\"\n    class=\"circular-chart\"\n  >\n    <path\n      class=\"circle-bg\"\n      d=\"M18 2.0845\n          a 15.9155 15.9155 0 0 1 0 31.831\n          a 15.9155 15.9155 0 0 1 0 -31.831\"\n    />\n    <path\n      class=\"circle\"\n      [style.stroke-dasharray]=\"(value / total) * 100 + ', 100'\"\n      d=\"M18 2.0845\n          a 15.9155 15.9155 0 0 1 0 31.831\n          a 15.9155 15.9155 0 0 1 0 -31.831\"\n    />\n  </svg>\n  <span class=\"percentage\">\n    {{ round(total ? (value / total) * 100 : 0, 1) }}%\n  </span>\n</div>\n", styles: [".progress-container{position:relative;flex-shrink:0}.progress-container .circular-chart{display:block}.progress-container .circle-bg{fill:none;stroke:#a9efea;stroke-width:4.8}.progress-container .circle{fill:none;stroke-width:4.8;stroke:#25c7bc;stroke-linecap:round;animation:progress 1s ease-out forwards}.progress-container .percentage{font-family:var(--FM-Medium);font-size:.875em;text-anchor:middle;position:absolute;top:calc(50% - .7em);left:calc(50% - 1.1em)}\n"] });
}
