...
import { Injectable, signal, computed, InjectionToken, Optional, Inject, inject, input, Input, Component, EventEmitter, Output, HostListener, Directive, PLATFORM_ID, effect, ContentChild, ViewChild, HostBinding, ViewEncapsulation } from '@angular/core';
import { retry, catchError, BehaviorSubject, Observable, map, throwError, finalize, tap, Subscription, fromEvent, filter } from 'rxjs';
...
const docSvg = '<svg width="auto" height="inherit" viewBox="0 0 26 32" fill="none" xmlns="http://www.w3.org/2000/svg"> <g opacity="0.5" clip-path="url(#clip0_11175_56159)"> <path d="M17.4109 1.09814H4.17876C3.39889 1.09814 2.65097 1.41215 2.09953 1.97108C1.54808 2.53001 1.23828 3.28809 1.23828 4.07854V27.9217C1.23828 28.7121 1.54808 29.4702 2.09953 30.0291C2.65097 30.5881 3.39889 30.9021 4.17876 30.9021H21.8216C22.6015 30.9021 23.3494 30.5881 23.9008 30.0291C24.4523 29.4702 24.7621 28.7121 24.7621 27.9217V8.54912L17.4109 1.09814Z" stroke="black" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/> <path d="M15.9404 1.09814V7.05893C15.9404 7.84938 16.2502 8.60745 16.8017 9.16638C17.3531 9.72532 18.101 10.0393 18.8809 10.0393H24.7619" stroke="black" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/> </g> <defs> <clipPath id="clip0_11175_56159"> <rect width="26" height="32" fill="white"/> </clipPath> </defs> </svg>';
