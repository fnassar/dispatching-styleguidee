...
class CustomModalComponent {
    ...
    static ɵcmp = i0.ɵɵngDeclareComponent({ minVersion: "14.0.0", version: "19.2.13", type: CustomModalComponent, isStandalone: true, selector: "modal", inputs: { modalTitle: "modalTitle", showDot: "showDot", headerButton: "headerButton" }, outputs: { hideEvent: "hideEvent", headerButtonClick: "headerButtonClick" }, ngImport: i0, template: "<div\n  *ngIf=\"isVisible\"\n  class=\"modal-overlay flex flex-row justify-start align-start\"\n  (click)=\"onOverlayClick($event)\"\n>\n  <!-- X button outside modal-content -->\n\n  <div class=\"flex flex-row\">\n    <div class=\"modal-content\" (click)=\"$event.stopPropagation()\">\n      <div class=\"modal-header\">\n        <span *ngIf=\"showDot\" class=\"modal-dot\"></span>\n        <span class=\"modal-title\">{{ modalTitle }}</span>\n        <div *ngIf=\"headerButton\">\n          <button\n            type=\"button\"\n            class=\"btn-header\"\n            (click)=\"onHeaderButtonClick()\"\n          >\n            {{ headerButton }}\n          </button>\n        </div>\n      </div>\n      <ng-content></ng-content>\n    </div>\n    <div class=\"flex justify-start\">\n      <button\n        type=\"button\"\n        class=\"btn-close\"\n        aria-label=\"Close\"\n        (click)=\"close()\"\n      >\n        <svg\n          width=\"40\"\n          height=\"40\"\n          viewBox=\"0 0 40 40\"\n          fill=\"none\"\n          xmlns=\"http://www.w3.org/2000/svg\"\n          aria-hidden=\"true\"\n        >\n          <line\n            x1=\"10\"\n            y1=\"10\"\n            x2=\"30\"\n            y2=\"30\"\n            stroke=\"currentColor\"\n            stroke-width=\"2\"\n            stroke-linecap=\"round\"\n          />\n          <line\n            x1=\"30\"\n            y1=\"10\"\n            x2=\"10\"\n            y2=\"30\"\n            stroke=\"currentColor\"\n            stroke-width=\"2\"\n            stroke-linecap=\"round\"\n          />\n        </svg>\n      </button>\n    </div>\n  </div>\n</div>\n", styles: [".modal-overlay{position:fixed;top:0;left:0;width:100vw;height:100vh;background:#000000b3;display:flex;align-items:center;justify-content:center;z-index:1000}.modal-content{background:#fff;border-radius:10px 0 10px 10px;min-width:600px;max-width:90vw;box-shadow:0 5px 15px #0000004d;position:relative;padding-bottom:24px;display:flex;justify-content:center;align-items:center;flex-direction:column}.modal-header{display:flex;width:100%;align-items:center;justify-content:start;padding:24px 24px 0;position:relative}.btn-header{cursor:pointer;border:#63748680 solid 1px;border-radius:.4em;padding:.3rem 1rem}.modal-title{flex:1;text-align:left;font-size:1rem;font-weight:600;width:min-content}.modal-dot{width:12px;height:12px;background:#25c7bc;border-radius:25%;margin-right:10px}.btn-close{height:1.5rem;width:1.5rem;padding:.2rem .3rem;background-color:#526275;display:flex;align-items:center;border-top-right-radius:25%;border-bottom-right-radius:25%;cursor:pointer;color:#fff;outline:none;font-size:large}.btn-close:hover{background-color:#4f5a6b}\n"], dependencies: [{ kind: "ngmodule", type: CommonModule }, { kind: "directive", type: i1$1.NgIf, selector: "[ngIf]", inputs: ["ngIf", "ngIfThen", "ngIfElse"] }] });
}
